...
<form id="form1">
			...
			<tbody id="directly_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="directlyImage_${i.index}" onchange="directlyUpImageFile(this)" hidden="hidden">
					</td>
					...
					<td class="td2" colspan="3" id="">
						<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
							<p style="margin-bottom:10px;">
								...
								<input class="input_amonut1 a easyui-numberbox" readonly="readonly" name="amount" id="directlyAmount_${i.index}" value="${invoice.amount }" onchange="directlyaddAmonut(this)"data-options="precision:2"/>
							</p>
							<p style="margin-bottom:5px;" >
								<span class="directlyfp_span">备注</span>
								<input class="input_amonut1 easyui-textbox" readonly="readonly" name="remark" id="directlyRemark_${i.index}" value="${invoice.remark }" />
							</p>
						</div>
					</td>
	...
	<%-- <a onclick="directlyappend(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
...
function directlyappend(obj) {
	...
	'<input type="file" id="directlyImage_'+a+'" onchange="directlyUpImageFile(this)" hidden="hidden"></td>'+
	'<td class="td2" colspan="3" id="directlyimagetd_'+a+'" style="width: 150px;">'+
	'<a onclick="directlyClickUpFile(this)" id="commClick_'+a+'" style="font-weight: bold;" href="#">'+
	...
	var id =obj.id;
     ...
     var y=num.substring(x+1,num.length);
   	  if(y!=0){
   		$('#directlyimagetd_' + j)
		.append(
				'<a onclick="directlyClickUpFile(this)" id="commClick_'
						+ j
     		...
     		$('#directlyimagetd_'+j).append('<a onclick="directlyClickUpFile(this)" id="commClick_'+j+'" style="font-weight: bold;" href="#">'+
