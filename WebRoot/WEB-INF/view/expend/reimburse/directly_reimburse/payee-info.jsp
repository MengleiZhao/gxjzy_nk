...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px">
		...
		onClickRow: onClickRowDPayerinfo,
		method: 'post',
		striped : true,
		nowrap : false,
		rownumbers:true,
		...
		">
			<thead>
				<tr>
					...
					<th data-options="field:'payeeAmount',align:'center',editor:{type:'numberbox',options:{required:true,editable:true,precision:2,iconCls:'icon-yuan',onChange:payeeAmountDir}}" width="16%">公务卡转账金额</th>
					<th data-options="field:'bankAccount',align:'center',editor:{type:'textbox',options:{required:true,editable:true}}" width="20%">收款人公务卡开户行</th>
					<th data-options="field:'bank',align:'center',editor:{type:'textbox',options:{required:true,editable:true}}" width="20%">收款人公务卡账号</th>
					<th data-options="field:'payeeAmountGR',align:'center',editor:{type:'numberbox',options:{editable:true,precision:2,iconCls:'icon-yuan',onChange:payeeAmountDirgr}}" width="16%">个人卡转账金额</th>
					<th data-options="field:'zfbAccount',align:'center',editor:{type:'textbox',options:{editable:true}}" width="20%">收款人个人卡开户行</th>
...
function payeeAmountDirgr(newVal,oldVal){
...
function onClickRowDPayerinfo(index) {
...
function payeeAmountDir(newVal,oldVal){
	if(newVal==undefined || oldVal==undefined){
		return false;
	}
	if(newVal==''){
