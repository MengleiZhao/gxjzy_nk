		...
		">
			<thead>
				<tr>
					...
					<th data-options="field:'payeeName',align:'center',editor:{type:'textbox'}" width="15%">收款人姓名</th>
					<th data-options="field:'payeeAmount',align:'center',editor:{type:'numberbox',options:{required:true,editable:true,precision:2}}" width="17%">公务卡转账金额</th>
					...
					<th data-options="field:'payeeAmountGR',align:'center',editor:{type:'numberbox',options:{required:true,editable:true,precision:2}}" width="17%">个人卡转账金额</th>
