			...
			<tbody id="hotel_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="imageHotel_${i.index}" accept="image/jpeg,image/jpg,image/png" onchange="upImageFilehotels(this)" hidden="hidden">
					</td>
					<td class="td2" colspan="3" id="zfbimagetdHotel_${i.index}" style="width: 150px;">
						<c:if test="${invoice.fileId!=null&&!empty invoice.fileId}">
							<img style="vertical-align:bottom;width: 100px; height: 73px;margin-left:0px" onclick="yl(this.src)" src="${base}/attachment/download/${invoice.fileId}"/><a style="color:red" href="#" onclick="deleteImagehotel(this)" id="hotelsc_${i.index}">    删除</a>
						</c:if>
						<c:if test="${invoice.fileId==null||empty invoice.fileId}">
							<a onclick="clickUpFilehotel(this)" id="clickhotel_${i.index}" style="font-weight: bold;" href="#">
...
function countTravel(obj){
	...
	function appendhotel(obj) {
		...
		'<input type="file" id="imageHotel_'+a+'" accept="image/jpeg,image/jpg,image/png" onchange="upImageFilehotels(this)" hidden="hidden"></td>'+
		'<td class="td2" colspan="3" id="zfbimagetdHotel_'+a+'" style="width: 150px;">'+
		'<a onclick="clickUpFilehotel(this)" id="clickhotel_'+a+'" style="font-weight: bold;" href="#">'+
		'<img style="vertical-align:bottom;margin-left:30px" src="${base}/resource-modality/${themenurl}/button/shangchuan1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">'+
		'</a></td>'+
		'<td class="td2" colspan="3" id="">'+
		'<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">'+
	...
	function upImageFilehotels(obj) {
						...
						success : function(data) {
				        	...
				        	if(y!=0){
								...
								.append(
					        		...
					        		$('#zfbimagetdHotel_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="hotelsc_'+j+'" onclick="deleteImagehotel(this)">    删除</a>');
					        	}
		...
		var id =obj.id;
	     ...
	     var y=num.substring(x+1,num.length);
	   	  if(y!=0){
	   		$('#zfbimagetdHotel_' + j)
			.append(
					'<a onclick="clickUpFilehotel(this)" id="clickhotel_'
							+ j
      		...
      		$('#zfbimagetdHotel_'+j).append('<a onclick="clickUpFilehotel(this)" id="clickhotel_'+j+'" style="font-weight: bold;" href="#">'+
