...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px">
	<table id="tracel_itinerary_detail_trip_tab_apply_id" class="easyui-datagrid" style="width:707px;height:auto"
	data-options="
	singleSelect: true,
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'fName',width:130,align:'center'">学生人员</th>
