			...
			<tbody id="other_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="otherimage_${i.index}" onchange="upImageFileOther(this)" hidden="hidden">
					</td>
					...
					<td class="td2" colspan="3" id="">
						<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
							<p style="margin-bottom:10px;">
								...
								<input class="input_amonut1 a easyui-numberbox" name="amount" readonly="readonly" id="otheramount_${i.index}" value="${invoice.amount}" onchange="addAmonut2(this)"data-options="precision:2"/>
								<!-- oninput = "value=value.replace(/^\D*(\d*(?:\.\d{0,2})?).*$/g, '$1')" value=""  -->
							</p>
							<p style="margin-bottom:5px;" >
								<span class="otherfp_span">备注：</span>
								<input  class="input_amonut1 easyui-textbox" name="remark" readonly="readonly" id="otherremark_${i.index}"value="${invoice.remark}" />
							</p>
						</div>
					</td>
...
function appendOther(obj) {
	...
	'<input type="file" id="otherimage_'+a+'" onchange="upImageFileOther(this)" hidden="hidden"></td>'+
