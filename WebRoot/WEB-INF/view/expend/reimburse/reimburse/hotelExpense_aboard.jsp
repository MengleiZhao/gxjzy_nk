...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px;border-top: 1px solid rgba(217,227,231,1);">
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'checkInTime',width:110,align:'center',editor:{type:'datebox', options:{editable:false,onChange:hotelStartTime}},formatter:ChangeDateFormat" >入住时间</th>
				<th data-options="field:'checkOUTTime',width:110,align:'center',editor:{type:'datebox',options:{editable:false,onChange:hotelEndTime}},formatter:ChangeDateFormat" >退房时间</th>
	...
	<div id="hoteltools" style="height:20px;padding-top : 8px">
		...
		<a href="javascript:void(0)" onclick="removehotel()" id="hotelRemoveId" style="float: right;"><img src="${base}/resource-modality/${themenurl}/button/scyh1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)"></a>
		<a style="float: right;">&nbsp;&nbsp;</a>
		<a href="javascript:void(0)" onclick="appendhotelRow()" id="hotelAppendId" style="float: right;"><img src="${base}/resource-modality/${themenurl}/button/tjyh1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)"></a>
	</div>
</div>
...
function hotelAmounts(newVal,oldVal){
	...
	var index=$('#hoteltabApply-reim').datagrid('getRowIndex',$('#hoteltabApply-reim').datagrid('getSelected'));
     ...
     for(var i=0;i<rows.length;i++){
		...
		$("#hotelAmounts").html(fomatMoney(num1,2)+"[元]");
