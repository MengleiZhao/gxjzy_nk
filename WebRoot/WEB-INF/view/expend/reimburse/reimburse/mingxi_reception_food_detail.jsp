			...
			<tbody id="food_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="foodimage_${i.index}" onchange="upImageFileFood(this)" hidden="hidden">
					</td>
					...
					<td class="td2" colspan="3" id="">
						<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
							<p style="margin-bottom:10px;">
								...
								<input class="input_amonut1 a easyui-numberbox" readonly="readonly" name="amount" id="foodamount_${i.index}" value="${invoice.amount}" onchange="addAmonut2(this)"data-options="precision:2"/>
								<!-- oninput = "value=value.replace(/^\D*(\d*(?:\.\d{0,2})?).*$/g, '$1')" value=""  -->
							</p>
							<p style="margin-bottom:5px;" >
								<span class="foodfp_span">备注：</span>
								<input  class="input_amonut1 easyui-textbox" name="remark" readonly="readonly" id="foodremark_${i.index}"value="${invoice.remark}" />
							</p>
						</div>
					</td>
...
function append2(obj) {
	...
	'<input type="file" id="foodimage_'+a+'" onchange="upImageFileFood(this)" hidden="hidden"></td>'+
