					...
					<td class="td2" colspan="3" id="">
						<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
							<p style="margin-bottom:10px;">
								...
								<input class="input_amonut1 a easyui-numberbox" readonly="readonly" name="amount" id="meetTrainamount_${i.index}" value="${invoice.amount}" onchange="addAmonutMT(this)"data-options="precision:2"/>
							</p>
							<p style="margin-bottom:5px;" >
								<span class="meetTrainfp_span">备注：</span>
								<input  class="input_amonut1 easyui-textbox" readonly="readonly" name="remark" id="meetTrainremark_${i.index}"value="${invoice.remark}" />
							</p>
						</div>
					</td>
