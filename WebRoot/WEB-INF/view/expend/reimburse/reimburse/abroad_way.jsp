...
<div class="window-tab" style="margin-top:10px;padding-top: 0px;margin-left: 0px;">
	...
	<thead>
		<tr>
			...
			<th data-options="field:'abroadDate',required:'required',align:'center',width:140,editor:{type:'datebox',options:{onChange:setDaysPlan1,onHidePanel:selectTime}},formatter:ChangeDateFormat">出发日期</th>
			<th data-options="field:'timeEnd',required:'required',align:'center',width:140,editor:{type:'datebox',options:{onChange:setDaysPlan2,onHidePanel:selectTime}},formatter:ChangeDateFormat">撤离日期/抵华日期</th>
...
//接待人员表格添加删除，保存方法
	...
	function selectAbroadDetail(index) {
		var win = creatFirstWin('选择-地区', 640, 580, 'icon-search', '/apply/chooseAbroad?index='+index+'&abroadType=reimb');
		win.window('open');
	...
	function addMiscellaneousFeeAndFoodInfo(){
		...
		var personNum = $("#fThisUnitTeamPersonNum").numberbox('getValue');
