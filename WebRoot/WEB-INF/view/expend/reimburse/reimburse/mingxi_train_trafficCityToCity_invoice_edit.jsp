...
<form id="form4">
			...
			<tbody id="outside_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="outsideImage_${i.index}" accept="image/jpeg,image/jpg,image/png" onchange="upImageFileOutside(this)" hidden="hidden">
					</td>
					<td class="td2" colspan="3" id="outsideZfbimagetd_${i.index}" style="width: 150px;">
	...
	<a onclick="appendOutsideCity(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
...
function countTravel(obj){
	...
	function appendOutsideCity(obj) {
		index = index + 1;
		...
		for (var i = 0; i < files.length; i++) {
			...
			$.ajax({
						...
						success : function(data) {
							upladFp(obj, "traveloutside", "fp03");
				        	...
				        	if(y!=0){
								...
								.append(
					        		...
					        		$('#outsideZfbimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="outsidesc_'+j+'" onclick="deleteImageOutside(this)">    删除</a>');
					        	}
		...
		var id =obj.id;
	     ...
	     var y=num.substring(x+1,num.length);
			...
			.append(
      		...
      		$('#outsideZfbimagetd_'+j).append('<a onclick="clickUpFileOutside(this)" id="clickOutside_'+j+'" style="font-weight: bold;" href="#">'+
