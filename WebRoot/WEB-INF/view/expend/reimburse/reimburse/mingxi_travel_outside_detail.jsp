...
<form id="form1">
	<table id="outsidefapiao" class="window-table-readonly-zc" cellspacing="0" cellpadding="0" style=" height: 100px;">
			...
			<tbody id="outside_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="text" id="fp_${i.index}" value="${invoice.fileId}" name="fileId" hidden="hidden">
						...
						success : function(data) {
				        	...
				        	if(y!=0){
								...
								.append(
					        		...
					        		$('#zfbimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="outsidesc_'+j+'" onclick="deleteImage(this)">    删除</a>');
					        	}
