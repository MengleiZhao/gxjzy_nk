	...
	<div style="width:580px;margin-top:10px">
		<div>
			<label>附</label> <input type="text" name="meetingSummaryYear1"
				class="under" readonly="readonly"
				value="${applyBean.meetingSummaryYear1}" />
				<label>年第 </label> <input type="text" name="meetingSummaryTime1"
				class="under" required="required" readonly="readonly"
				value="${applyBean.meetingSummaryTime1}"/>
...
<div class="window-table" style="margin-bottom:10px;margin-left: 10px;">
	<div style="width:580px;margin-top:10px">
		<div >
			<label>附</label> <input type="text" name="meetingSummaryYear2"
				class="under" readonly="readonly"
				value="${applyBean.meetingSummaryYear2}" />
				<label>年第 </label> <input type="text" name="meetingSummaryTime2"
				class="under" readonly="readonly"
				value="${applyBean.meetingSummaryTime2}"/>
