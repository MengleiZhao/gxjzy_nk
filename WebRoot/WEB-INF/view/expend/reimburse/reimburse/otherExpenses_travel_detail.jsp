...
<div class="window-tab" style="margin-left: 0px;padding-top: 0px;">
	<table id="rec-other-detail-apply-dg" class="easyui-datagrid" style="width:707px;height:auto"
	data-options="
	singleSelect: true,
	toolbar: '#other_detail_apply_id',
	...
	<div id="other_detail_apply_id" style="height:20px;">
