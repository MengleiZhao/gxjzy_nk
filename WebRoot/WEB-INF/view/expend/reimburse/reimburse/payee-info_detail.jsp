				...
				<tr>
					...
					<th data-options="field:'payeeName',align:'center',editor:{type:'combobox',
						...
						options:{
							...
							onSelect:aftersuccesss,
							mouseover:nameMouseovers,
						}
					}" width="15%">收款人姓名</th>
					<th data-options="field:'payeeAmount',align:'center',editor:{type:'numberbox',options:{required:true,editable:true,precision:2,iconCls:'icon-yuan',onChange:payeeAmountss}}" width="17%">公务卡转账金额</th>
					<th data-options="field:'bankAccount',align:'center',editor:{type:'textbox',options:{required:true,editable:true}}" width="17%">收款人公务卡开户行</th>
					<th data-options="field:'bank',align:'center',editor:{type:'textbox',options:{required:true,editable:true}}" width="17%">收款人公务卡账号</th>
					<th data-options="field:'payeeAmountGR',align:'center',editor:{type:'numberbox',options:{required:true,editable:true,precision:2,iconCls:'icon-yuan',onChange:payeeAmountss}}" width="17%">个人卡转账金额</th>
					<th data-options="field:'zfbAccount',align:'center',editor:{type:'textbox',options:{required:true,editable:true}}" width="17%">收款人个人卡开户行</th>
					<th data-options="field:'wxAccount',align:'center',editor:{type:'textbox',options:{required:true,editable:true}}" width="17%">收款人个人卡账号</th>
...
function payeeAmountss(newVal,oldVal){
