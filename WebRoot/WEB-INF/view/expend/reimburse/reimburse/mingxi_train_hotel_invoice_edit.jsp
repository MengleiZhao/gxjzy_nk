...
<form id="form2">
			...
			<tbody id="hotel_${i.index}" >
				<tr>
					...
					<td class="td2" colspan="3" id="hotelimagetd_${i.index}" style="width: 150px;">
						...
						<c:if test="${invoice.fileId==null||empty invoice.fileId}">
						<a onclick="clickUpFileHotel(this)" id="hotelclick_${i.index}" style="font-weight: bold;" href="#">
	...
	<a onclick="appendHotelEdit(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
	...
	var id =obj.id;
     ...
     var y=num.substring(x+1,num.length);
		...
		.append(
     		...
     		$('#hotelimagetd_'+j).append('<a onclick="clickUpFileHotel(this)" id="hotelclick_'+j+'" style="font-weight: bold;" href="#">'+
