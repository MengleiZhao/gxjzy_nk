...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px;border-top: 1px solid rgba(217,227,231,1);">
	...
	<table id="reimbursein_city_detail_tabs_id" class="easyui-datagrid" style="width:695px;height:auto"
	data-options="
	singleSelect: true,
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'fPerson',width:220,align:'center' ">姓名</th>
				<th data-options="field:'fSubsidyDay',width:220,align:'center' ">补助天数</th>
				<th data-options="field:'fApplyAmount',width:227,align:'center' ">报销金额</th>
				<th data-options="field:'fStdAmount',hidden:true"></th>
				<th data-options="field:'fPersonId',hidden:true,width:220,align:'center' ">姓名ID</th>
			</tr>
		</thead>
	</table>
