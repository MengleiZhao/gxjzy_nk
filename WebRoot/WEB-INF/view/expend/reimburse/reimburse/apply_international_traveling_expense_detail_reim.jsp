	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'timeStart',width:110,align:'center',formatter:ChangeDateFormat">出发日期</th>
				<th data-options="field:'timeEnd',width:110,align:'center',formatter:ChangeDateFormat">到达日期</th>
				<th data-options="field:'startCity',width:115,align:'center'">出发地</th>
				<th data-options="field:'arriveCity',width:115,align:'center'">目的地</th>
				<th data-options="field:'vehicle',hidden:true,width:120,align:'center'">交通工具</th>
				<th data-options="field:'vehicleText',width:130,align:'center'">交通工具</th>
				<th data-options="field:'vehicleLevel',width:160,align:'center'">交通工具级别</th>	
				<th data-options="field:'applyAmount',width:87,align:'center'">申请费用</th>
				<th data-options="field:'trainSubsidies',hidden:true,width:170,align:'center'">其中国际列车补助（美元）</th>
			</tr>
		</thead>
	</table>
