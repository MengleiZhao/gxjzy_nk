...
<form id="form2">
	<table id="hotelfapiao" class="window-table-readonly-zc" cellspacing="0" cellpadding="0" style=" height: 100px;width:695px;">
		<tbody id="hotel_0" >
			<tr>
				...
				<td class="td2" colspan="3" id="hotelimagetd_0" style="width: 150px;">
				...
				<td class="td2" colspan="3" id="">
					<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
						<p style="margin-bottom:10px;">
							...
							<input class="input_amonut1 a easyui-numberbox" name="amount" id="hotelamount_0" onchange="addAmonut2(this)"data-options="precision:2"/>
	...
	<a onclick="appendHotelAdd(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
					...
					success : function(data) {
			        	...
			        	if(y!=0){
							...
							.append(
				        		...
				        		$('#hotelimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="sc_'+j+'" onclick="deleteImageHotel(this)">    删除</a>');
				        	}
