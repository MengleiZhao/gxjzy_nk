...
<form id="form1">
			...
			<tbody id="comm_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="commImage_${i.index}" accept="image/jpeg,image/jpg,image/png" onchange="commUpImageFile(this)" hidden="hidden">
					</td>
					<td class="td2" colspan="3" id="commimagetd_${i.index}" style="width: 150px;">
						...
						<c:if test="${empty invoice.fileId}">
							<a onclick="commClickUpFile(this)" id="commClick_${i.index}" style="font-weight: bold;" href="#">
					...
					<td class="td2" colspan="3" id="">
						<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
							<p style="margin-bottom:10px;">
								...
								<input class="input_amonut1 a easyui-numberbox" name="amount" id="commAmount_${i.index}" value="${invoice.amount }" onchange="commaddAmonut(this)"data-options="precision:2"/>
							</p>
							<p style="margin-bottom:5px;" >
								<span class="commfp_span">备注：</span>
								<input  class="input_amonut1 easyui-textbox" name="remark" id="commRemark_${i.index}" value="${invoice.remark }" />
							</p>
						</div>
					</td>
	...
	<a onclick="commappendEdit(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
...
function commappendEdit(obj) {
	index = index + 1;
	var fromNum = parseInt(obj.parentNode.parentNode.children[1].children[5].children.length);
	...
	'<input type="file" id="commImage_'+a+'" accept="image/jpeg,image/jpg,image/png" onchange="commUpImageFile(this)" hidden="hidden"></td>'+
