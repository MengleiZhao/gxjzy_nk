...
<form id="form2">
	<table id="hotelAttendfapiao" class="window-table-readonly-zc" cellspacing="0" cellpadding="0" style=" height: 100px;width:695px;">
		<tbody id="hotelAttend_0" >
			<tr>
				<td class="td1" style="width: 100px;">
					&nbsp;&nbsp;<span id="hotelAttendFp_0">发票1</span>
					<input type="text" id="hotelAttendfp_0" name="fileId" hidden="hidden">
					<input type="file" id="hotelAttendimage_0" accept="image/jpeg,image/jpg,image/png" onchange="upImageFilehotelAttend(this)" hidden="hidden">
				</td>
				<td class="td2" colspan="3" id="hotelAttendimagetd_0" style="width: 150px;">
					<a onclick="clickUpFilehotelAttend(this)" id="hotelAttendclick_0" style="font-weight: bold;" href="#">
				...
				<td class="td2" colspan="3" id="">
					<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
						<p style="margin-bottom:10px;">
							...
							<input class="input_amonut1 a easyui-numberbox" name="amount" id="hotelAttendamount_0" onchange="addAmonut2(this)"data-options="precision:2"/>
							<!-- oninput = "value=value.replace(/^\D*(\d*(?:\.\d{0,2})?).*$/g, '$1')" value=""  -->
						</p>
						<p style="margin-bottom:5px;" >
							<span class="hotelAttendfp_span">备注：</span>
							<input  class="input_amonut1 easyui-textbox" name="remark" id="hotelAttendremark_0" value="" />
						</p>
					</div>
				</td>
			</tr>
	...
	<a onclick="appendhotelAttendReim(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
...
function appendhotelAttendReim(obj) {
	index = index + 1;
	...
	'<a onclick="clickUpFilehotelAttend(this)" id="hotelAttendclick_'+a+'" style="font-weight: bold;" href="#">'+
	'<img style="vertical-align:bottom;margin-left:30px" src="${base}/resource-modality/${themenurl}/button/shangchuan1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">'+
	'</a></td>'+
	'<td class="td2" colspan="3" id="">'+
	'<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">'+
...
function clickUpFilehotelAttend(obj) {
	var id = obj.id;
					...
					success : function(data) {
			        	...
			        	if(y!=0){
							...
							.append(
				        		...
				        		$('#hotelAttendimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="sc_'+j+'" onclick="deleteImagehotelAttend(this)">    删除</a>');
				        	}
	...
	var id =obj.id;
     ...
     var y=num.substring(x+1,num.length);
   	  if(y!=0){
   		$('#hotelAttendimagetd_' + j)
		.append(
				'<a onclick="clickUpFilehotelAttend(this)" id="hotelAttendclick_'
						+ j
     		...
     		$('#hotelAttendimagetd_'+j).append('<a onclick="clickUpFilehotelAttend(this)" id="hotelAttendclick_'+j+'" style="font-weight: bold;" href="#">'+
