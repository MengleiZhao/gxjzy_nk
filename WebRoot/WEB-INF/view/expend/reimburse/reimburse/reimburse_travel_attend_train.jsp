	...
	<div class="window-div" style="">
		<div class="window-left-div" style="width:755px;height: 491px;border: 1px solid #D9E3E7;margin-top: 20px">
			<div class="window-left-top-div">
				...
				<!-- 报销人Id --><input type="hidden" name="user" value="${bean.user}" id="input_user"/>
				<!-- 报销部门 --><input type="hidden" name="deptName" value="${bean.deptName}" id="input_deptName"/>
				<!-- 报销人级别 --><input type="hidden" value="${bean.userLevel}" id="fUserLevel"/>
				...
				<input type="hidden" id="meetTrainAmount" name="meetTrainAmount" <c:if test="${operation=='edit' }">value="${bean.meetTrainAmount}"</c:if><c:if test="${operation=='add'}">value="${applyBean.meetTrainAmount}"</c:if> /><!-- 培训学费 -->
				...
				<div class="tab-wrapper" id="reimburse-travelinfo-add">
					...
					<div class="tab-content">
						<div title="报销" style="margin-bottom:35px;width: 737px" data-options="iconCls:'icon-xxlb'">
							<jsp:include page="reimburset_travelinfo_attend_train.jsp" />
						</div>
