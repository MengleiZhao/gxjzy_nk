			...
			<tbody id="costRent_${i.index}" >
				<tr>
					<td class="td1" style="width: 100px;">
						...
						<input type="file" id="image_${i.index}" onchange="upImageFile(this)" hidden="hidden">
					</td>
...
function countTravel(obj){
	...
	function append(obj) {
		...
		'<input type="text" id="costRentfp_0'+a+'" name="fileId" hidden="hidden">'+
		'<input type="file" id="image_'+a+'" onchange="upImageFile(this)" hidden="hidden"></td>'+
						...
						success : function(data) {
				        	...
				        	if(y!=0){
								...
								.append(
					        		...
					        		$('#zfbimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="costRentsc_'+j+'" onclick="deleteImageCostRent(this)">    删除</a>');
					        	}
		...
		var id =obj.id;
	     ...
	     var y=num.substring(x+1,num.length);
			...
			.append(
      		...
      		$('#zfbimagetd_'+j).append('<a onclick="clickUpFileCostRent(this)" id="clickCostRent_'+j+'" style="font-weight: bold;" href="#">'+
