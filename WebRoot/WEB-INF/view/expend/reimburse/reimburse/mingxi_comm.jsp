...
<form id="form1">
		...
		<tbody id="comm_0" >
			<tr>
				<td class="td1" style="width: 100px;">
					&nbsp;&nbsp;<span id="commFp_0">发票1</span>
					<input type="text" id="commfp_0" name="fileId" hidden="hidden">
					<input type="file" id="commImage_0" accept="image/jpeg,image/jpg,image/png" onchange="commUpImageFile(this)" hidden="hidden">
				</td>
				<td class="td2" colspan="3" id="commimagetd_0" style="width: 150px;">
					<a onclick="commClickUpFile(this)" id="commClick_0" style="font-weight: bold;" href="#">
				...
				<td class="td2" colspan="3" id="">
					<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
						<p style="margin-bottom:10px;">
							...
							<input class="input_amonut1 a easyui-numberbox" name="amount" id="commAmount_0" onchange="commaddAmonut(this)"data-options="precision:2"/>
						</p>
						<p style="margin-bottom:5px;" >
							<span class="commfp_span">备注：</span>
							<input  class="input_amonut1 easyui-textbox" name="remark" id="commRemark_0" value="" />
						</p>
					</div>
				</td>
			</tr>
	...
	<a onclick="commappendAdd(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
