...
<form id="form3">
	<table id="meetTrainfapiao" class="window-table-readonly-zc" cellspacing="0" cellpadding="0" style=" height: 100px;width:695px;">
		<tbody id="meetTrain_0" >
			<tr>
				<td class="td1" style="width: 100px;">
					&nbsp;&nbsp;<span id="meetTrainFp_0">发票1</span>
					<input type="text" id="meetTrainfp_0" name="fileId" hidden="hidden">
					<input type="file" id="meetTrainimage_0" accept="image/jpeg,image/jpg,image/png" onchange="upImageFileMeetTrain(this)" hidden="hidden">
				</td>
				<td class="td2" colspan="3" id="meetTrainimagetd_0" style="width: 150px;">
					<a onclick="clickUpFileMeetTrain(this)" id="meetTrainclick_0" style="font-weight: bold;" href="#">
				...
				<td class="td2" colspan="3" id="">
					<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
						<p style="margin-bottom:10px;">
							...
							<input class="input_amonut1 a easyui-numberbox" name="amount" id="meetTrainamount_0" onchange="addAmonutMT(this)"data-options="precision:2"/>
							<!-- oninput = "value=value.replace(/^\D*(\d*(?:\.\d{0,2})?).*$/g, '$1')" value=""  -->
						</p>
						<p style="margin-bottom:5px;" >
							<span class="meetTrainfp_span">备注：</span>
							<input  class="input_amonut1 easyui-textbox" name="remark" id="meetTrainremark_0" value="" />
						</p>
					</div>
				</td>
			</tr>
	...
	<a onclick="appendHotelTrain(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
...
function appendHotelTrain(obj) {
	...
	'<input type="file" id="meetTrainimage_'+a+'" accept="image/jpeg,image/jpg,image/png" onchange="upImageFileMeetTrain(this)" hidden="hidden"></td>'+
...
function upImageFileMeetTrain(obj) {
			        	...
			        	if(y!=0){
							...
							.append(
									'<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="sc_'
											+ j
											+ '" onclick="deleteImageMT(this)">    删除</a>');
				        	}else{
				        		$('#meetTrainimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="sc_'+j+'" onclick="deleteImageMT(this)">    删除</a>');
				        	}
