		...
		<thead>
			<tr>
				...
				<th data-options="field:'lecturerLevel',width:180,align:'center',editor:{type:'combobox',options:{
								...
								onChange:onChangeLecturerLevel
							}}">职称/职务</th>
				...
				<th data-options="field:'bank',width:180,align:'center',editor:'textbox'">发卡行名</th>
...
//表格添加删除，保存方法
	...
	function loadHotel(nameArr){
		...
		$('#mingxi-hotel-dg').datagrid('selectRow', 0).datagrid('beginEdit',
				0);
		editIndex5 = 0;
	}
	//加载伙食费列表
	function loadFood(nameArr){
		...
		$('#mingxi-food-dg').datagrid('selectRow', 0).datagrid('beginEdit',
				0);
		editIndex6 = 0;
	}
	//加载城市间交通费列表
	function loadTraffic1(nameArr){
		...
		$('#mingxi-trafficCityToCity-dg').datagrid('selectRow', 0).datagrid('beginEdit',
				0);
		editIndex7 = 0;
	}
	//加载市内交通费列表
...
function onChangeLecturerLevel(newVal,oldVal){
