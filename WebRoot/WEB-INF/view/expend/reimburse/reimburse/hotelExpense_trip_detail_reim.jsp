...
<div class="window-tab" style="margin-left: 0px;padding-top: 0px;">
	...
	">
		<thead>
			<tr>
               ...
               <th data-options="field:'travelChummage',width:150,align:'center',
				         editor:{
				             type:'combobox',
				             options:{
				             	editable:false,
	...
	<table style="width:707px;height:auto">
		<tr class="trbody">
			...
			<input class="easyui-numberbox" id="hotelTeacherAmounts" readonly="readonly" value="${bean.hotelTeacherAmount}"style="width: 85px;height: 30px;margin-left: 10px " >
			</td>
			<td style="width: 120px;text-align: right;">学生金额合计（元）：</td>
			<td style="width: 1px;text-align: left;" >
			<input class="easyui-numberbox" id="hotelStudentAmounts" readonly="readonly" value="${bean.hotelStudentAmount}" style="width: 85px;height: 30px;margin-left: 10px " >
			</td>
		</tr>
	</table>
</div>
