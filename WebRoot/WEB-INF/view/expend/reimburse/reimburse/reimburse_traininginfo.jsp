...
<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 0px;">
	...
	<tr class="trbody">
		...
		<td class="td2">
			...
			value="${reimbTrainingBean.fProvinceId}" required="required" editable="false" data-options="editable:false,
				...
				onSelect: function(rec){
				    ...
				    var url = '${base}/apply/getRegion?id='+rec.id+'&selected=${reimbTrainingBean.fCityId}';
		...
		<td class="td2">
			<input class="easyui-combobox" style="width: 205px;; height: 30px;" id="fCityId" name="fCityId" <c:if test="${operation=='edit'}"> readonly="readonly"</c:if>
			value="${reimbTrainingBean.fCityId}" required="required" editable="false" data-options="editable:false,
				...
				onSelect: function(rec){
					...
					$('#fDistrictId').combobox('setValue', '');
				    var url = '${base}/apply/getRegion?id='+rec.id+'&selected=${reimbTrainingBean.fDistrictId}';
	...
	<tr class="trbody">
		...
		<td class="td2">
			...
			value="${reimbTrainingBean.fDistrictId}" required="required" editable="false" data-options="editable:false,method:'POST',valueField:'id',textField:'text'"/>
		</td>
		<td class="td4" style="width: 67px;"></td>
		<td class="td1" style="width: 70px;"><span class="style1">*</span> 详细地址</td>
		<td class="td2">
			<input class="easyui-textbox" style="width: 205px;; height: 30px;" id="trPlace" name="trPlace" <c:if test="${operation=='edit'}"> readonly="readonly"</c:if>
