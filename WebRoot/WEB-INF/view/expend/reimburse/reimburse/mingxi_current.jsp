...
<form id="form1">
		...
		<tbody id="current_0" >
			<tr>
				<td class="td1" style="width: 100px;">
					&nbsp;&nbsp;<span id="currentFp_0">发票1</span>
					<input type="text" id="currentfp_0" name="fileId" hidden="hidden">
					<input type="file" id="currentImage_0" accept="image/jpeg,image/jpg,image/png" onchange="currentUpImageFile(this)" hidden="hidden">
				</td>
				<td class="td2" colspan="3" id="currentimagetd_0" style="width: 150px;">
					<a onclick="currentClickUpFile(this)" id="currentClick_0" style="font-weight: bold;" href="#">
				...
				<td class="td2" colspan="3" id="">
					<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
						<p style="margin-bottom:10px;">
							...
							<input class="input_amonut1 a easyui-numberbox" name="amount" id="currentAmount_0" onchange="currentaddAmonut(this)"data-options="precision:2"/>
						</p>
						<p style="margin-bottom:5px;" >
							<span class="currentfp_span">备注：</span>
							<input  class="input_amonut1 easyui-textbox" name="remark" id="currentRemark_0" value="" />
						</p>
					</div>
				</td>
			</tr>
	...
	<a onclick="currentappendCurrent(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
...
function currentappendCurrent(obj) {
	index = index + 1;
	...
	'<input type="file" id="currentImage_'+a+'" accept="image/jpeg,image/jpg,image/png" onchange="currentUpImageFile(this)" hidden="hidden"></td>'+
