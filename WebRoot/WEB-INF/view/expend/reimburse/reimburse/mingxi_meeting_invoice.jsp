...
<form id="form1">
		...
		<tbody id="meeting_0" >
			<tr>
				<td class="td1" style="width: 100px;">
					&nbsp;&nbsp;<span id="meetingFp_0">发票1</span>
					<input type="text" id="meetingfp_0" name="fileId" hidden="hidden">
					<input type="file" id="meetingImage_0" accept="image/jpeg,image/jpg,image/png" onchange="upImageFile(this)" hidden="hidden">
				</td>
				<td class="td2" colspan="3" id="meetingZfbimagetd_0" style="width: 150px;">
					<a onclick="clickUpFile(this)" id="meetingClick_0" style="font-weight: bold;" href="#">
				...
				<td class="td2" colspan="3" id="">
					<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
						<p style="margin-bottom:10px;">
							<span class="meetingFp_span" >金额(元)：</span>
							<input class="input_amonut1 a easyui-numberbox" name="amount" id="meetingAmount_0" onchange="addAmonut(this)"data-options="precision:2"/>
						</p>
						<p style="margin-bottom:5px;" >
							<span class="meetingFp_span">备注：</span>
							<input  class="input_amonut1 easyui-textbox" name="remark" id="meetingRemark_0" value="" />
						</p>
					</div>
				</td>
			</tr>
	...
	<a onclick="appendMeeting(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
...
function countTravel(obj){
	...
	function appendMeeting(obj) {
		...
		'<input type="file" id="meetingImage_'+a+'" accept="image/jpeg,image/jpg,image/png" onchange="upImageFile(this)" hidden="hidden"></td>'+
		'<td class="td2" colspan="3" id="meetingZfbimagetd_'+a+'" style="width: 150px;">'+
		'<a onclick="clickUpFile(this)" id="meetingClick_'+a+'" style="font-weight: bold;" href="#">'+
		'<img style="vertical-align:bottom;margin-left:30px" src="${base}/resource-modality/${themenurl}/button/shangchuan1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">'+
		'</a></td>'+
		'<td class="td2" colspan="3" id="">'+
		'<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">'+
						...
						success : function(data) {
				        	...
				        	if(y!=0){
								...
								.append(
					        		...
					        		$('#meetingZfbimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="sc_'+j+'" onclick="deleteImage(this)">    删除</a>');
					        	}
		...
		var id =obj.id;
	     ...
	     var y=num.substring(x+1,num.length);
	   	  if(y!=0){
	   		$('#meetingZfbimagetd_' + j)
			.append(
					'<a onclick="clickUpFile(this)" id="meetingClick_'
							+ j
      		...
      		$('#meetingZfbimagetd_'+j).append('<a onclick="clickUpFile(this)" id="meetingClick_'+j+'" style="font-weight: bold;" href="#">'+
