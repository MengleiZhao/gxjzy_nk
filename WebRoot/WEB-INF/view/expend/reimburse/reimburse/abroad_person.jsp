...
<div class="window-tab"  style="margin-top:10px;padding-top: 0px;margin-left: 0px;"  >
	...
	<div id="abroad-person-id" style="margin-right:0px;float:right" >
	...
	<table id="abroad-person-dg" class="easyui-datagrid" style="width:695px;height:auto;"
	data-options="
	toolbar: '#dmp',
	...
	<thead>
		<tr>
			...
			<th data-options="field:'travelPeopId',required:'required',hidden:true,editor:{type:'textbox',options:{editable: true}}"></th>
		</tr>
	</thead>
</table>
</div>
...
function removeitPerson1() {
	var rows = $('#abroad-person-dg').datagrid('getSelections');
	if (rows.length != 0) {
        for(var i = 0; i < rows.length; i++){
            var rowIndex = $('#abroad-person-dg').datagrid('getRowIndex', rows[i]);
            $('#abroad-person-dg').datagrid('deleteRow', rowIndex);  
        }
	} else {
		alert('请选择一条记录！');
		return false;
