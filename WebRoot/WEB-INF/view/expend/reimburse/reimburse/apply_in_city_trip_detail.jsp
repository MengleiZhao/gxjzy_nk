...
<div class="window-tab" style="margin-left: 0px;padding-top: 0px;">
	<table id="rec-other-trip-detail-apply-dg" class="easyui-datagrid" style="width:707px;height:auto"
	data-options="
	singleSelect: true,
	toolbar: '#other_trip_detail_apply_id',
	<c:if test="${!empty applyBean.gId}">
	url: '${base}/apply/receptionOthers?gId=${applyBean.gId}&fType=1',
	</c:if>
	<c:if test="${empty applyBean.gId}">
	url: '',
	</c:if>
	...
	<div id="other_trip_detail_apply_id" style="height:20px;">
