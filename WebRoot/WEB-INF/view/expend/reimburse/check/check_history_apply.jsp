...
<div class="window-tab" style="margin-left: 0px;margin-top: 10px">
	...
	<table id="check-history-dg-comm" class="easyui-datagrid"  style="width:690px;height:auto"
	data-options="
	...
	<thead>
		<tr>
			<th data-options="field:'fuserName',required:'required',align:'center',width:100">审批人</th>
			<th data-options="field:'fcheckResult',required:'required',align:'center',width:100,formatter: YJ">审批结果</th>
			<th data-options="field:'fcheckTime',required:'required',align:'center',width:150,formatter: ChangeDateFormat">审批时间</th>
			<th data-options="field:'fcheckRemake',required:'required',align:'center',width:240">审批意见</th>
