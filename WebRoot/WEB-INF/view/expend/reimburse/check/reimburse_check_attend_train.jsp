				...
				<div class="tab-wrapper" id="reimburse-travelinfo-add">
					...
					<div class="tab-content">
						<div title="报销单" style="margin-bottom:35px;" data-options="iconCls:'icon-xxlb'">
							<jsp:include page="../reimburse/reimburset_travelinfo_attend_train_detail.jsp" />
						</div>
						<div title="申请单" style="overflow:auto;margin-bottom:35px;" data-options="iconCls:'icon-xxlb'">
							<jsp:include page="../reimburse/apply_detail_attend_train.jsp" />
						</div>
					</div>
				</div>
			</div>
...
function onclickreimburset(){
	if(itineraryurlcount>0){
		...
		$('#reimburse_outside_detail_tab_id').datagrid('reload');
		$('#reimbursein_city_detail_tabs_id').datagrid('reload');
		$('#reimbursein_hoteltab_detail').datagrid('reload');
		$('#reimbursein_foodtab_detail').datagrid('reload');
