...
<body>
<div class="win-div">
<form id="reimburse_audit_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
...
function check(result) {
	...
	$('#reimburse_audit_form').form('submit', {
		onSubmit : function() {
		...
		success : function(data) {
			...
			if (data.success) {
				...
				closeWindow();
				$('#reimburse_audit_form').form('clear');
