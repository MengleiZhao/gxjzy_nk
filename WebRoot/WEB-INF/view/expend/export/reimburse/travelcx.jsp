  ...
  <!--[if gte mso 9]>
   <xml>
       ...
       <x:WorksheetOptions>
        ...
        <x:Panes>
         <x:Pane>
          ...
          <x:RangeSelection>N10</x:RangeSelection>
         </x:Pane>
        </x:Panes>
    ...
    <x:ExcelName>
     ...
     <x:Formula>=Sheet1!$A$1:$I$21</x:Formula>
    </x:ExcelName>
   </xml>
  <![endif]-->
 </head>
 <body link="blue" vlink="purple">
  <table width="1021.80" border="0" cellpadding="0" cellspacing="0" style='width:766.35pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <tr height="138.67" style='height:104.00pt;mso-height-source:userset;mso-height-alt:2080;'>
    ...
    <td style="text-align: center;" colspan="2" id="reimbursetravelcx"></td> 
   </tr>
   ...
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    <td class="xl72" height="33.33" style='height:25.00pt;' x:str>出行人员</td>
    <td class="xl73" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${bean.travelpepol }</td>
    <td class="xl72" x:str>出行人数</td>
    <td class="xl72" colspan="4" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'>${travelpepolnumber }</td>
   </tr>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    <td class="xl72" height="52" style='height:39.00pt;' x:str>出行教师</td>
    <td class="xl72" x:str>随行学生</td>
    <td class="xl72" x:str>出行日期</td>
    <td class="xl72" x:str>目的地</td>
    <td class="xl72" x:str>出行区域</td>
   ...
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    <td class="xl72" height="33.33" style='height:25.00pt;'>${i.travelAttendPeop }</td>
    <td class="xl72">${i.fName }</td>
    <td class="xl75"><fmt:formatDate value="${i.travelAreaTime }" pattern="yyyy-MM-dd"/></td>
    <td class="xl72">${i.travelAreaName }</td>
    <td class="xl72">${i.areaNames }</td>
   ...
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    ...
    <td class="xl72" colspan="2" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>所在辖区</td>
   ...
   <tr height="52" style='height:39.00pt;mso-height-source:userset;mso-height-alt:780;'>
    ...
    <td class="xl77" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str><input type="checkbox" disabled="disabled"  <c:if test="${pro.FProOrBasic==1  }">checked="checked" readonly="readonly"</c:if>>项目支出名称（编号）：</td>
    <td class="xl77" colspan="4" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;'><c:if test="${pro.FProOrBasic==1  }">${bean.proDetailName }</c:if></td>
   </tr>
   <tr height="64" style='height:48.00pt;mso-height-source:userset;mso-height-alt:960;'>
    <td class="xl77" height="124" rowspan="2" style='height:93.00pt;border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>审批</td>
    <td class="xl78" x:str>项目负责人：</td>
    <td class="xl79">${proHead }</td>
    <td class="xl78" x:str>部门负责人：</td>
    <td class="xl79">${role1 }</td>
    <td class="xl78" colspan="3" style='border-right:none;border-bottom:.5pt solid windowtext;' x:str>归口管理部门负责人：</td>
    <td class="xl85">${role2 }</td>
   </tr>
   <tr height="60" style='height:45.00pt;mso-height-source:userset;mso-height-alt:900;'>
    <td class="xl78" x:str>主管校长：</td>
    <td class="xl79">${role3 }</td>
    <td class="xl78" x:str>财务校长：</td>
    <td class="xl79">${role4 }</td>
    <td class="xl78" colspan="3" style='border-right:none;border-bottom:.5pt solid windowtext;' x:str>校长：</td>
    <td class="xl85">${role5 }</td>
   </tr>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
    <td class="xl80" height="33.33" style='height:25.00pt;' x:str>财务审核：</td>
    <td class="xl81" colspan="3" style='border-right:none;border-bottom:.5pt solid windowtext;'>${financeCheck }</td>
    <td class="xl82" x:str>财务报销：</td>
    <td class="xl83" colspan="2" style='border-right:none;border-bottom:.5pt solid windowtext;'></td>
    <td class="xl84" x:str>领款人：</td>
    <td class="xl86"></td>
   </tr>
   <tr height="33.33" style='height:25.00pt;mso-height-source:userset;mso-height-alt:500;'>
