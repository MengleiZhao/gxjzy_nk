...
$(document).ready(function() {
	/* var isForeign = $('input[name="isForeign"]:checked').val();	
	if(isForeign=='1'){
		$('#rec-food-dg').datagrid().datagrid('hideColumn', 'time');
		$('#rec-food-dg').datagrid().datagrid('showColumn', 'date');
	}else{
		$('#rec-food-dg').datagrid().datagrid('showColumn', 'time');
		$('#rec-food-dg').datagrid().datagrid('hideColumn', 'date');
	} */
	/* //设值时间
				...
				<div title="基本信息" data-options="collapsible:false" style="overflow:auto;">
					<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 3px;width:707px;">
						<tr class="trbody">
							...
							<td colspan="3">
									<input class="easyui-textbox" style="width: 606px;height: 30px; " value="${bean.gName}" name="gName" readonly="readonly" required="required" data-options="validType:'length[1,50]'"/>
							</td>
						</tr>
							<!-- 公务接待信息 -->
						...
						<div style="overflow:auto;margin-top: 0px">
							...
							<div style="overflow:auto;margin-top: 10px;">
								<span style="float: left;">
									<span style="color: red;"  >申请总额总计： </span>
			...
			<%-- 	<c:if test="${!empty bean.meetingSummaryYear1}">
				<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;">
					<div title="三重一大会议信息" data-options="collapsible:false" style="overflow:auto; ">
						<jsp:include page="../add/check_meeting_infomation_detail.jsp" />
					</div>
				</div>
				</c:if> --%>
				<!-- 审批记录 -->
