...
<div class="window-tab" style="margin-left: 0px;padding-top: 10px;border-top: 1px solid rgba(217,227,231,1);">
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'fDays',align:'center',width:260,editor:{type:'numberbox',precision:2,readonly:true}" >补贴天数</th>
				<th data-options="field:'fApplyAmount',align:'center',width:260,editor:{type:'numberbox',precision:2}" >补贴金额</th>
	...
	<div id="foodtool" style="height:20px;padding-top : 8px">
		...
		<a style="float: left;color: #666666;font-size:12px;">申请金额：<span id="applyFoodAmount"><fmt:formatNumber groupingUsed="true" value="${bean.foodAmount}" minFractionDigits="2" maxFractionDigits="2"/>[元]</span></a>
