						...
						<tr class="trbody">
							...
							<td class="td2">
								<c:if test="${operation=='add' }">
									<input class="easyui-textbox" style="width: 265px;height: 30px;margin-left: 10px " value="${draftAdd}" name="gName" required="required" data-options="validType:'length[1,50]'"/>
								</c:if>
								<c:if test="${operation!='add' }">
									<input class="easyui-textbox" style="width: 265px;height: 30px;margin-left: 10px  " value="${bean.gName}" name="gName" required="required" data-options="validType:'length[1,50]'"/>
								</c:if>
							</td>
							<td class="td1" style="width: 70px;"><span class="style1">*</span> 出行时间</td>
							<td class="td2" >
							<input class="easyui-datebox" id="tripdate" name="tripdate" value="${bean.tripdate}" style="width: 261px;height: 30px;margin-left: 10px " >
							</td>
						</tr>
						<tr class="trbody">
