...
<div class="window-tab" style="margin-left: 0px;padding-top: 0px;">
	<table id="rec-other-trip-detail-dg" class="easyui-datagrid" style="width:707px;height:auto"
	data-options="
	singleSelect: true,
	toolbar: '#other_trip_detail_id',
	...
	<div id="other_trip_detail_id" style="height:20px;">
