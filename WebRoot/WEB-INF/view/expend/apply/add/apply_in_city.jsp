...
<div class="window-tab" style="margin-left: 0px;">
	...
	">
		<thead>
			<tr>
				...
				<th data-options="field:'fSubsidyDay',width:260,align:'center',editor:{type:'textbox',options:{editable:true}}">补贴天数</th>
				<th data-options="field:'fApplyAmount',width:260,align:'center',editor:{type:'numberbox',options:{editable:true,precision:2}}">补贴费用</th>
			</tr>
		</thead>
	</table>
	<div id="in_city_id" style="height:30px;padding-top : 8px">
		...
		<a style="float: left;color: #666666;font-size:12px;">申请费用：<span id="applyInCityAmount"><fmt:formatNumber groupingUsed="true" value="${bean.cityAmount}" minFractionDigits="2" maxFractionDigits="2"/>[元]</span></a>
	</div>
