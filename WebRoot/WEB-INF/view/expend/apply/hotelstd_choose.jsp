		...
		<div class="list-table" >
			<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 3px;width:597px;">
				...
				<tr class="trbody">
					...
					<td class="td2" colspan="3">
					<input class="easyui-combobox" id="shiId" name="shiId" style="width: 535px;height: 30px;margin-left: 10px " data-options="
					editable:false,
					method:'POST',
					valueField:'id',
					textField:'text',
				...
				<tr class="trbody">
					...
					<td class="td2" colspan="3">
					<input class="easyui-combobox" id="quId" name="quId" style="width: 535px;height: 30px;margin-left: 10px " data-options="editable:false,method:'POST',valueField:'id',textField:'text'">
					</td>
				</tr>
			</table>
...
function saveRegion(){
    ...
    if(shengId=='2260'){
	    editors[6].target.textbox('setValue', quId);
    }else{
    	if(quId==''){
	    	editors[6].target.textbox('setValue', shiId);
		}else{
	    	editors[6].target.textbox('setValue', quId);
		}
    }
    onChangeApplyAreaId(shiId);
	closeFirstWindow();
}
var tabId = '${tabId}';
//初始化datagrid点击事件
