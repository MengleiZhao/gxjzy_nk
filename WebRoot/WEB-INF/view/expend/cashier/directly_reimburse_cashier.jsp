...
<body>
<div class="win-div">
<form id="directly_reimburse_cashier_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
					...
					<div title="基本信息" data-options="iconCls:'icon-xxlb'" style="overflow:auto;margin-top: 10px;">
						<table cellpadding="0" cellspacing="0" class="ourtable">
							...
							<tr class="trbody">
								...
								<td class="td4">
									<!-- 隐藏域 --> 
									<!-- 主键ID --><input type="hidden" name="drId" id="drId" value="${bean.drId}" />
...
function save() {
	var id = $('#drId').val();
	$('#directly_reimburse_cashier_form').form('submit', {
		onSubmit : function() {
		...
		url : base + '/cashier/simplePayRegister?id='+id+'&registertype=0',
		success : function(data) {
			...
			if (data.success) {
				...
				closeWindow();
				$('#directly_reimburse_cashier_form').form('clear');
