							...
							<div title="领用单详情" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
								<table class="ourtable" cellpadding="0" cellspacing="0">
									...
									<tr class="trbody">
										...
										<td class="td2">
											<input class="easyui-datebox" class="dfinput"  id="R_fReqTime" name="fReqTime"  readonly="readonly" 
									...
									<tr style="height: 70px;">
										...
										<td  colspan="4">
											<input class="easyui-textbox" data-options="multiline:true,validType:'length[0,200]'" readonly="readonly" required="required" id="R_fReceRemark" name="fReceRemark" style="width: 555px;height:62px" value="${bean.fReceRemark}">  
