					...
					<div title="资产登记表" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
						<table class="ourtable" border="0" cellpadding="0" cellspacing="0">
							...
							<tr style="height: 70px;">
								...
								<td  colspan="4">
									<input class="easyui-textbox" data-options="multiline:true,validType:'length[1,200]'" readonly="readonly" id="S_fRemark_S" name="fRemark_S" style="width: 555px;height:62px;" value="${bean.fRemark_S}">  
