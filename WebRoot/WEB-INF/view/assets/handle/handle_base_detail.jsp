					...
					<div title="处置单详情" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
						<table class="ourtable" cellpadding="0" cellspacing="0">
							...
							<tr style="height: 70px;">
								...
								<td  colspan="4">
									<input class="easyui-textbox" data-options="multiline:true" readonly="readonly" required="required" id="H_fHandleRemark" name="fHandleRemark" style="width: 555px;height:60px" value="${bean.fHandleRemark}">  
