...
<div class="window-tab" style="margin-left: 0px;margin-top: 10px">
	<table id="check-history-dg-ys" class="easyui-datagrid"  style="width:700px;height:auto"
	data-options="
	<c:if test="${empty foCodeYS}">
	url: '',
	</c:if>
	<c:if test="${!empty foCodeYS}">
	url: '${base}/wflow/history?fpId=${fpIdYS}&foCode=${foCodeYS}',
	</c:if>
	method: 'post'
	">
	<thead>
