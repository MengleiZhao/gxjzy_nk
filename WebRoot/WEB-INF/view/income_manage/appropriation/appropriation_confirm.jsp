...
<form id="appropriation_confirm_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
					...
					<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 3px;">
						<tr class="trbody">
							...
							<td class="td2">
								...
								<input name="fApplyDate" id="fApplyDate" value="true" class="easyui-datebox" style="width:200px;height:30px"/>
							</td>
						</tr>
						<tr class="trbody">
						...
						<tr class="trbody">
							...
							<td class="td2">
								<input id="paymentActualDate" name="paymentActualDate" value="${bean.paymentActualDate}" class="easyui-datebox"
							...
							<td class="td2">
								<input class="easyui-textbox" id="accountingDocument"
...
//送审
function confirm() {
	$('#appropriation_confirm_form').form('submit', {
		onSubmit : function() {
		...
		url : base + '/appropriation/confirmAppropriation',
		success : function(data) {
			...
			if (data.success) {
				...
				$('#appropriation_confirm_form').form('clear');
