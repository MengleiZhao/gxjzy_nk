...
<div class="list-div">
	...
	<div style="margin: 0 10px 0 10px;height: 445px;">	
		<table id="appropriationTab" class="easyui-datagrid"
			data-options="collapsible:true,url:'${base}/appropriation/appropriationCheckPage',
...
<script type="text/javascript">
	...
	//操作栏创建
	function CZ(val, row) {
		var fFlowStatus = row.fFlowStatus;
		if (fFlowStatus == 9) {
			return null;
		}else {
			return '<table><tr style="width: 75px;height:20px"><td style="width: 25px">'+
			   ...
			   '<a href="#" onclick="checkAppropriation(' + row.aId + ')" class="easyui-linkbutton">'+
	...
	//审批
	function checkAppropriation(id) {
		var win = creatWin('审批', 1115, 600, 'icon-search', '/appropriation/check?id=' + id);
		win.window('open');
	}
</script>
</body>
