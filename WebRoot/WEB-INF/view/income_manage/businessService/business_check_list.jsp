		...
		selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns: true">
			<thead>
				<tr>
					...
					<th data-options="field:'fBusiTime',align:'center',resizable:false,sortable:true,formatter: ChangeDateFormat" style="width: 15%">申请日期</th>
...
function check_business(id) {
	var win = creatWin('审批', 1105, 580, 'icon-search', '/business/check?id=' + id);
	win.window('open');
}
</script>
</body>
