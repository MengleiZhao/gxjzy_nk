...
<form id="form_data_exports" method="post">
	<input type="hidden" id="data_year_export_name" name="indexName" value="">
	<input type="hidden" id="data_year_export_code" name="fincomeNum" value="">
</form>
<script type="text/javascript">
	...
	function CZ(val,row) {		
		/* return 	'<table><tr style="width: 75px;height:20px"><td style="width: 25px">'+
				'<a href="#" onclick="detailRegist(' + row.fincomeId + ')" class="easyui-linkbutton">'+
				'<img onmouseover="listMouseOver(this)" onmouseout="listMouseOut(this)" src="'+base+'/resource-modality/${themenurl}/list/select1.png">'+
				'</a>'+ '</td><td style="width: 25px">'+
				'<a href="#" onclick="updateRegst(' + row.fincomeId + ')" class="easyui-linkbutton">'+
				'<img onmouseover="listMouseOver(this)" onmouseout="listMouseOut(this)" src="'+base+'/resource-modality/${themenurl}/list/update1.png">'+
				'</a>' + '</td><td style="width: 25px">'+ 
				'<a href="#" onclick="deleteRegist(' + row.fincomeId + ')" class="easyui-linkbutton">'+
				...
				if ( c == 1 || c == 2) {
					return 	'<table><tr style="width: 75px;height:20px"><td style="width: 25px">'+
					   		...
					   		'<img onmouseover="listMouseOver(this)" onmouseout="listMouseOut(this)" src="'+base+'/resource-modality/${themenurl}/list/select1.png">'+
					   	 '</a></td><td style="width: 25px">'+
							'<a href="#" onclick="reCall(\'registerTab\',' + row.fincomeId + ',\'/srregister/reCall\')" class="easyui-linkbutton">'+
							'<img onmouseover="listMouseOver(this)" onmouseout="listMouseOut(this)" src="'+base+'/resource-modality/${themenurl}/list/reCall1.png">'+
					   		'</a></td></tr></table>';
				}else if(c == 0 || c == -1|| c == -4) {
					return 	'<table><tr style="width: 75px;height:20px"><td style="width: 25px">'+
							'<a href="#" onclick="detail_business(' + row.fincomeId + ')" class="easyui-linkbutton">'+
							'<img onmouseover="listMouseOver(this)" onmouseout="listMouseOut(this)" src="'+base+'/resource-modality/${themenurl}/list/select1.png">'+
							'</a>'+ '</td><td style="width: 25px">'+
							'<a href="#" onclick="updateRegst(' + row.fincomeId + ')" class="easyui-linkbutton">'+
							'<img onmouseover="listMouseOver(this)" onmouseout="listMouseOut(this)" src="'+base+'/resource-modality/${themenurl}/list/update1.png">'+
					...
					return 	'<table><tr style="width: 75px;height:20px"><td style="width: 25px">'+
			   		...
			   		'</a></td></tr></table>';
			   		/* <td style="width: 25px">'+
					'<a href="#" onclick="exportHtml(' + row.fincomeId + ')" class="easyui-linkbutton">'+
	...
	function exportHtml(id) {
		window.open(base+"/incomeExport/businessRegister?id="+ id);
	}	
</script>
</body>
</html>
