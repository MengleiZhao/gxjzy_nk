...
.xl97
 ...
 <body link="blue" vlink="purple">
  <table width="1037" border="0" cellpadding="0" cellspacing="0" style='width:777.75pt;border-collapse:collapse;table-layout:fixed;'>
   ...
   <col width="78" style='mso-width-source:userset;mso-width-alt:2816;'/>
   ...
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    <td class="xl67" height="53.33" style='height:40.00pt;' x:str>申请人：</td>
    ...
    <td class="xl70" x:str><fmt:formatDate value="${bean.reqTime}" pattern="yyyy年MM月dd日"/></td>
   </tr>
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    <td class="xl71" height="53.33" style='height:40.00pt;' x:str>来款项目名称</td>
    <td class="xl72" colspan="8" style='border-right:1.0pt solid windowtext;border-bottom:.5pt solid windowtext;'>${bean.proName }</td>
   </tr>
   <tr height="164" style='height:123.00pt;mso-height-source:userset;mso-height-alt:2460;'>
    ...
    <td class="xl74" colspan="8" style='border-right:1.0pt solid windowtext;border-bottom:none;'>${bean.contenExplain }</td>
   </tr>
   ...
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    ...
    <td class="xl81" colspan="2" style='border-right:none;border-bottom:.5pt solid windowtext;'>${bean.registerMoneyCapital}</td>
    <td class="xl82" colspan="2" style='border-right:none;border-bottom:.5pt solid windowtext;' x:str>（小写）¥：</td>
    <td class="xl83" colspan="2" style='border-right:1.0pt solid windowtext;border-bottom:.5pt solid windowtext;'>${bean.registerMoney}</td>
   </tr>
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
   ...
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    ...
    <td class="xl91"></td>
    <td class="xl92" colspan="3" style='border-right:1.0pt solid windowtext;border-bottom:none;' x:str>次校长办公会会议纪要</td>
   </tr>
   <tr height="53.33" style='height:40.00pt;mso-height-source:userset;mso-height-alt:800;'>
    <td class="xl93"></td>
