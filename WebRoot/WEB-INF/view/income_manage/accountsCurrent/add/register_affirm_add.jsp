...
function saveRegisterAffirm(flowStauts){
	var accDocNumber = $('#accDocNumber').textbox('getValue');
				...
				<div title="基本信息" data-options="collapsed:false,collapsible:false"style="overflow:auto;">
					<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 3px;">
						...
						<tr class="trbody">
							...
							<td colspan="3">
								<input class="easyui-textbox" style="width: 590px;height: 30px; " readonly="readonly" value="${bean.conCode}" id="conCode" name="conCode" data-options="prompt:'请选择合同编号'"/>
							</td>
						</tr>
						<tr class="trbody">
							<td class="td1"><span class="style1"> </span> 合同名称</td>
							<td colspan="3">
								<input class="easyui-textbox" style="width: 590px;height: 30px; " readonly="readonly" value="${bean.conName}" id="conName" name="conName" readonly="readonly" data-options="prompt:'请选择合同名称'"/>
							</td>
						</tr>
						<tr class="trbody">
							...
							<td class="td1" style="width: 70px;"><span class="style1">*</span> 会计凭证号</td>
							<td class="td2" >
								<input class="easyui-textbox" id="accDocNumber" name="accDocNumber" value="${bean.accDocNumber}" style="width: 247px;height: 30px;margin-left: 10px">
							</td>
						</tr>
					</table>
				</div>				
