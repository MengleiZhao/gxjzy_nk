...
<div class="window-left-top-div" >
	...
	<input type="hidden" name="fjfStauts" id="F_JFSTATUS" value="${bean.fjfStauts}"/>
...
<div class="tab-wrapper" id="contract-dispute-edit">
	...
	<jsp:include page="../base/contract-dispute-base.jsp" />
	</div>
	...
	<a href="javascript:void(0)" onclick="disputeSaveForm(1)">
	<img src="${base}/resource-modality/${themenurl}/button/baocun1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">
	</a>&nbsp;
	<a href="javascript:void(0)" onclick="disputeSaveForm(2)">
...
function change_upFile(obj){
	...
	//	var plan = getPlan();
		...
		function fPurchNo_DC(){
			...
			var win=creatFirstWin('选择-采购订单号',550,450,'icon-add','/PurchaseApply/PurchNoList');
			win.window('open');
		}
		function quota_DC(){
			//var node=$('#dispute_dg').datagrid('getSelected');
		...
		function onclickdetail(){
			if(abroadDetailcount>=1){
				...
				abroadDetailcount+=1;
				$('#apply_expense_detail_tab_id').datagrid('reload');
				$('#abroad-person-detail-dg').datagrid('reload');
				$('#abroad-plan-dg').datagrid('reload');
				$('#travel-way-dg').datagrid('reload');
