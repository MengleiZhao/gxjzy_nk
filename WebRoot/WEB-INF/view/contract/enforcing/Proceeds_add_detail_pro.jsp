...
<body>
<form id="proceeds_add_detail" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
...
flashtab('contract-enforcing-add');	
	...
	function saveEnforcing(fPlanId,stauts){
    	...
    	$('#proceeds_add_detail').form('submit', {
	...
	//				param.planJson=plan;
				...
				success:function(data){
					...
					if(data.success){
						...
						$('#proceeds_add_detail').form('clear');
