...
<table class="window-table" cellspacing="0" cellpadding="0">
	<tr class="trbody">
		<td class="td1"><span class="style1">*</span>&nbsp;收款人名称</td>
		<td class="td2">
		...
		<td class="td2">
			<input class="easyui-combobox" id="paymentTypeShow" required="required" readonly="readonly" value="${payee.paymentType}"  style="width: 200px; height: 30px;" data-options="validType:'selectValid',editable:false,url:base+'/lookup/lookupsJson?parentCode=FKFS&selected=${payee.paymentType}',method:'POST',valueField:'text',textField:'text'"/>
		</td> --%>
	</tr>
	...
	<tr class="trbody" id="bank-info1">
		...
		<td class="td2">
			<input class="easyui-textbox" required="required" id="bankName" readonly="readonly" style="width: 200px; height: 30px;" name="bank" value="${payee.bank}" />
		</td>
		<td class="td1"><span class="style1">*</span>&nbsp;银行卡号</td>
		<td class="td2">
			<input class="easyui-textbox" required="required"  readonly="readonly" style="width: 200px; height: 30px;" id="bankAccount" name="bankAccount" value="${payee.bankAccount}" />
		</td>
	</tr>
