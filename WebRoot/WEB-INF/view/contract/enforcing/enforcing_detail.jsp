							...
							<div title="付款信息" data-options="iconCls:'icon-xxlb'" style="overflow:auto;margin-top: 10px;">
								<table cellpadding="0" cellspacing="0" class="ourtable" style="margin-left: 20px">
									<tr class="trbody">
										...
										<td class="td2">
											<input id=""  class="easyui-textbox" readonly="readonly" required="required"  name="" style="width: 200px;"
										...
										<td class="td1"><span class="style1">*</span>&nbsp;付款阶段</td>
										<td class="td2">
											<input id=""  class="easyui-textbox" readonly="readonly" required="required"  name="" style="width: 200px;" value="${payBean.fRecStage}"/>
										</td>
									</tr>
									...
									<tr class="trbody">
										...
										<td>
											<input  class="easyui-datebox" readonly="readonly" required="required" name="" style="width: 200px;" value="${payBean.fRecePlanTime}"/>
										</td>
										<td class="td4">&nbsp;</td>
										<td class="td1"><span class="style1">*</span>&nbsp;计划付款金额</td>
										<td class="td2">
											<input  class="easyui-textbox" readonly="readonly" required="required" name="fReceAmount" style="width: 200px;" value="${payBean.fRecePlanAmount}"/>
										</td>
									</tr>
									...
									<tr class="trbody">
										...
										<td class="td2"  colspan="4">
											<input id=""  class="easyui-textbox" readonly="readonly" required="required" style="width: 555px;" value="${bean.fBudgetIndexName}"/>
										</td>
									</tr>
									...
									<%-- <tr class="trbody">
										<td class="td1"><span class="style1">*</span>&nbsp;计划付款金额</td>
										<td class="td2">
											<input  class="easyui-textbox" readonly="readonly"  name="" style="width: 200px;" value="${payBean.fRecePlanAmount}"/>
										</td>
										<td class="td4">&nbsp;</td>
									...
									<tr class="trbody">
										...
										<td colspan="4">
											<input id=""  class="easyui-numberbox" data-options="validType:'length[1,20]',icons: [{iconCls:'icon-yuan'}],precision:2"  name="fReceAmount" style="width: 200px;" value="${payBean.fRecePlanAmount}"/>
										</td>
									</tr> --%>
									<tr class="trbody">
											<td class="td1">
