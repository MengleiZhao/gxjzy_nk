						...
						<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 3px;width:707px;">
									...
									<tr class="trbody">
									 ...
									 <tr class="trbody">
										...
										<td class="td2">
											<input  class="easyui-numberbox" required="required" id="fReAmount" name="fReAmount" data-options="icons: [{iconCls:'icon-yuan'}],precision:2" style="width: 200px;height: 30px" value="${contBean.fReAmount}"/>
										</td>
									</tr> 
									<tr class="trbody">
...
flashtab('contract-enforcing-add');	
	...
	//				param.planJson=plan;
				...
				url:'${base}/proceedsPlan/savesk?fPlanId='+fPlanId,
				type:'post',
				async:true,
				success:function(data){
					if(flag){
