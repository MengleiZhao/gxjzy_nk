...
<body>
<form id="proceeds_add_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
		...
		<div class="window-left-div" style="width:765px;height: 491px;border: 1px solid #D9E3E7;margin-top: 20px;">
			<div class="win-left-top-div">
					...
					<div title="收款信息" data-options=" collapsible:false" style="overflow:auto;">
						<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 3px;width:707px;">
									<tr class="trbody">
										...
										<td class="td2">
											<input id="fProceedsProperty"  class="easyui-combobox" required="required" name="fProceedsProperty" data-options="editable:true,valueField:'text',
												textField:'text',
												validType:'selectValid',
												onShowPanel:onShowPanel" style="width: 200px;height: 30px"
											value="${payBean.fProceedsProperty}"/>
										</td>
										
										<td class="td1"><span class="style1">*</span>&nbsp;收款条件</td>
										<td class="td2">
											<input id="fProceedsCondition"  class="easyui-textbox" required="required"  name="fProceedsCondition" style="width: 200px;height: 30px" value="${payBean.fProceedsCondition}"/>
										</td>
									</tr>
								
									<tr class="trbody">
										<td class="td1"><span class="style1">*</span>&nbsp;收款金额</td>
										<td class="td2">
											<input  class="easyui-textbox" required="required" name="fReceAmount" style="width: 200px;height: 30px" value="${payBean.fProceedsAmount}"/>
										</td>
										<td class="td1"><span class="style1">*</span>&nbsp;收款日期</td>
										<td class="td2">
											<input  class="easyui-datebox" required="required" name="fProceedsTime" style="width: 200px;height: 30px" value="${payBean.fProceedsTime}"/>
										</td>
									</tr>
									<tr class="trbody">
			 ...
			 <div class="win-left-bottom-div">
				<a href="javascript:void(0)" onclick="saveEnforcing('${payBean.fPId}',0)">
					<img src="${base}/resource-modality/${themenurl}/button/zhanchun1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">
				</a>&nbsp;&nbsp;
				<a href="javascript:void(0)" onclick="saveEnforcing('${payBean.fPId}',1)">
...
function onShowPanel(){
    $('#fProceedsProperty').combobox('reload', '${base}/Expiration/lookupsJson?parentCode=FKXZ');
	}
	...
	function saveEnforcing(fPlanId,stauts){
		...
		$.ajax({ 
			type: 'POST', 
			url: '${base}/proceedsPlan/getUptStatus?id='+id,
			dataType: 'json', 
			async:false, 
	...
	//				param.planJson=plan;
				...
				url:'${base}/proceedsPlan/savesk?fPlanId='+fPlanId+'&id=${bean.fcId}',
				type:'post',
				async:true,
				success:function(data){
					if(flag){
