				...
				<div class="easyui-accordion" style="width:662px;margin-left: 0px;">
					<div  data-options="iconCls:'icon-xxlb'" style="overflow:auto;margin-top:10px;">	
								<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
									...
									<tr class="trbody">
										<%-- <td class="td1"><span class="style1">*</span>&nbsp;合同形式</td>
										<td class="td2">
											<input class="easyui-combobox" id="F_fContStyle" required="required" name="fContStyle.code" style="width: 200px" data-options="editable:false,panelHeight:'auto',url:'${base}/Formulation/lookupsJson?parentCode=HTXS&selected=${bean.fContStyle.code}',method:'POST',valueField:'code',textField:'text',editable:false,validType:'selectValid'">
										</td> --%>
										<td class="td1">协同部门</td>
										<td class="td2">
											<select id="F_assisDeptId"  readonly="readonly" class="easyui-combobox" name="assisDeptId" data-options="validType:'length[1,20]'" style="width: 200px" >
									...
									<tr class="trbody">
										...
										<td class="td2">
											<input class="easyui-numberbox" id="F_fcAmount" readonly="readonly" required="required" name="fcAmount" data-options="icons: [{iconCls:'icon-yuan'}],precision:2" style="width: 200px" value="${bean.fcAmount}"/>
										</td>
										<td class="td4">&nbsp;</td>
									...
									<tr class="trbody">
										...
										<td class="td2">
											<input id="F_fOperator" class="easyui-textbox" readonly="readonly" type="text" required="true" data-options="validType:'length[1,25]'" style="width: 200px" value="${bean.fOperator}"/>
										</td >
									</tr>
									<tr id="cg1" hidden="hidden">
										<td class="td1"><span class="style1">*</span>&nbsp;采购订单</td>
										<td  colspan="4">
											<input id="F_fPurchName" readonly="readonly" class="easyui-textbox" name="fPurchName" data-options="prompt:'单击打开选取采购订单',validType:'length[1,32]'" value="${bean.fPurchName}" style="width: 555px"/>
										</td>
									</tr>
									...
									<%-- <tr class="trbody">
										<td class="td1"><span class="style1">*</span>&nbsp;合同签署人</td>
										<td class="td2">
											<input id="F_fSignUser"  class="easyui-textbox" type="text" readonly="readonly" required="required" name="fSignUser" data-options="validType:'length[1,20]'" style="width: 200px" value="${bean.fSignUser}"/>
										</td >
										<td class="td4">&nbsp;</td>
