		...
		<table class="top-table" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td align="right" style="padding-right: 10px">
					...
					&nbsp;
					<a href="#" onclick="queryProList1('pro_tz_dg');">
						<img style="vertical-align:bottom" src="${base}/resource-modality/${themenurl}/button/detail1.png" onMouseOver="mouseOver(this)" onMouseOut="mouseOut(this)">
					</a>
					&nbsp;
					<a href="#" onclick="clearProList1('pro_tz_dg');">
			...
			method:'post',fit:true,pagination:true,singleSelect: false,scrollbarSize:0,rownumbers:true,pageSize:100000,
				...
				<thead>
					<tr>
						...
						<th data-options="field:'fproName',align:'center',formatter:formatCellTooltip" width="15%">项目名称</th>
						...
						<th data-options="field:'fproAppliPeople',align:'center', formatter:isEmpty" width="10%">申请人</th>
...
<form id="form_xmtz_export" method="post" enctype="multipart/form-data">
	<input type="hidden" name="sbkLx" value="zxmtz">
