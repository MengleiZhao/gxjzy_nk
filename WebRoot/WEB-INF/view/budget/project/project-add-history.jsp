...
<!-- <div class="window-tab" style="margin-left: 0px">这个是去掉左移 -->
	...
	<table id="check-history-dg" class="easyui-datagrid"  style="width:960px;height:auto"
	data-options="
	...
	<div id="accessoryCSS" style="display: none;">
		<div id="accessoryCSS1">
			<%-- <div style="width:40%;height:200px;position: relative;margin-left: 20%;background:rgba(255,255,255,1);border:1px solid rgba(217,227,231,1);opacity:1;border-radius:4px;">
				<div style="width:100%;height:25px;background:rgba(204,204,205,1);opacity:1;border-radius:4px 4px 0px 0px;"><span style="margin-left: 10px;color: black;text-align: center;line-height: 26px">附件详情</span></div>
				<table id="htmlShow"></table>
				<div class="footer">
							<a href="#" onclick="accessory()">
