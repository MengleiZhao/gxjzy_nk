...
<%@ include file="/includes/taglibs.jsp"%>
	<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;width: 990px">
		...
		<div style="overflow:auto;margin-top: 0px;">
			<table id="pro_purchase_tab_id" class="easyui-datagrid" style="width:980px;height:auto"
			data-options="
			singleSelect: true,
			...
			">
				<thead>
					<tr>
						...
						<th data-options="field:'fProcurementNum',align:'center',editor:{type:'numberbox', options:{requerd:true,onChange:onChangeProcurementNum}}" style="width: 15%">采购数量</th>
						<th data-options="field:'fMeasurement',align:'center',editor:{type:'textbox', options:{requerd:true,onChange:onChangeMeasurement}}" style="width: 15%">计量单位</th>
...
<div id="purManyYearsPro_toolbar_Id" style="height:30px;width: 970px;margin-top: 15px;margin-right: 30px">
...
<table id="purManyYearsProTabId" class="easyui-datagrid" style="width:980px;height:auto"
			data-options="
			singleSelect: true,
...
function onChangeMeasurement(newVal,oldVal){
	if(newVal==undefined || oldVal==undefined){
		return false;
	}
	var flagMe = true;
