...
<div class="easyui-accordion" data-options="" style="width:990px;margin-left: 20px">
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr class="trbody">
		     	...
		     	<td class="td2" colspan="4">
					...
					<input type="hidden" id="project_add_FProOrBasic" onchange="FProOrBasicChange(${bean.FProOrBasic})" name="FProOrBasic" value="${bean.FProOrBasic}"/>
		     		...
		     		<input type="hidden" id="hyjyfile" name="hyjyfile" >
		     	</td>
		   	</tr>
		    ...
		    <tr class="trbody">
				...
				<td class="td3-ys"></td>
     			...
     			<td class="td2">
     				<input class="easyui-textbox" style="height:30px; width: 300px" readonly="readonly" id="bigProName" name="bigProName" value="${bean.bigProName}"/>
     			</td>
		    </tr>
		    ...
		    <tr class="trbody">
		    	<td class="td1-ys"><span class="style_must">*</span>&nbsp;计划开始执行年份</td>
     			...
     			<td class="td2">
					<input class="easyui-combobox" id="proUseType" readonly="readonly" name="proUseType" style="width: 300px;height: 30px;" data-options="editable:false,url:'${base}/Formulation/lookupsJson?parentCode=YSSYLX&selected=${bean.proUseType}',method:'POST',valueField:'code',textField:'text'">
     			</td>
		    </tr>
			<tr class="trbody" >
		 	...
		 	<c:if test="${bean.ifScientificPro=='1'}">
				<tr class="trbody">
	...
	<div title="会议纪要" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top: 10px;">
		<table cellpadding="0" cellspacing="0" >
			<tr class="trbody">
		    	<td class="td1-ys" style="padding-top: 0px" colspan="6">
		    		<%@ include file="check_pro_essb_minutes.jsp" %>
				</td>
		    </tr>
		</table>
	</div>
