...
<%@ include file="/includes/taglibs.jsp"%>
	<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;width: 990px">
		<div id="mingxiProIdSEDetail" title="政府采购明细表" data-options="collapsed:false,collapsible:false"style="overflow:auto;width: 980px">
		<div style="overflow:auto;margin-top: 0px;">
			<table id="pro_purchase_tab_detail_SE_id" class="easyui-datagrid" style="width:980px;height:auto"
			data-options="
			singleSelect: true,
	...
	<table cellpadding="0" cellspacing="0" style="width:870px;height:auto;margin-left: 20px;margin-right: 20px;">
	<tr class="trbody">
		<td style="float: left;margin-top: 20px" colspan="4">是否为一采多年项目
     		<input type="radio" value="1" disabled="disabled" name="ifPurchaseManyYearsSEPro" <c:if test="${bean.ifPurchaseManyYearsSEPro=='1'}">checked="checked" </c:if> style="vertical-align: middle;"/>&nbsp;&nbsp;是
			&nbsp;&nbsp;
			<input type="radio" value="0" disabled="disabled" name="ifPurchaseManyYearsSEPro" <c:if test="${bean.ifPurchaseManyYearsSEPro=='0'||bean.ifPurchaseManyYearsSEPro==''||empty bean.ifPurchaseManyYearsSEPro}">checked="checked" </c:if> style="vertical-align: middle;"/>&nbsp;&nbsp;否
		</td>
	</tr>
</table>

<div id="purManyYearsPro_toolbar_detail_SE_Id" style="height:30px;width: 970px;margin-top: 15px;margin-left: 20px;margin-right: 20px;">
...
<table id="purManyYearsProTabSEId" class="easyui-datagrid" style="width:980px;height:auto;margin-left: 20px;margin-right: 20px;"
		data-options="
		singleSelect: true,
		toolbar: '#purManyYearsPro_toolbar_detail_SE_Id',
		rownumbers : true,
