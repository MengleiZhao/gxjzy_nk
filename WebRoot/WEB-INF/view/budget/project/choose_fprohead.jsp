...
//查询
function queryCF() {
	$('#choose_fprohead_dg').datagrid('load',{
...
//双击选择页面
$('#choose_fprohead_dg').datagrid({
	onDblClickRow: function(rowIndex, rowData){
		$('#project-add-FProHead').textbox('setValue',rowData.name);
		$('#pro_add_FProHeadId').val(rowData.id);
		closeSecondWindow();
	}
});
</script>
