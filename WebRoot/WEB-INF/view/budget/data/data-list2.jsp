...
<div class="list-div">
	...
	<div class="list-top">
		...
		<tr id="data_index_top">
					<td class="top-table-search-pro">预算指标编码&nbsp;
	...
	<div class="list-table-tab">
			<div class="tab-wrapper" id="bdata-tab2">
				...
				<div style="height: 440px">
					...
					data-options="collapsible:true,url:'${base}/bData/progList1?orderColumn=indexCode,indexName,deptName&indexType=3',
			   	...
			   	<div style="height: 440px">
					...
					data-options="collapsible:true,url:'${base}/bData/progList1?orderColumn=deptName,indexCode,indexName&indexType=3',
