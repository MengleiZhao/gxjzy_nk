...
<body style="background-color: #f0f5f7;text-align: center;">
	<div class="list-div">
		...
		<div class="list-top">
			<table id="researchProjects_check_dg"  class="top-table" cellpadding="0" cellspacing="0">
				<tr>
		...
		<div style="margin: 0 10px 0 10px;height: 445px;">	
			<table id="researchProjects_check_tab" class="easyui-datagrid"
				data-options="collapsible:true,url:'${base}/researchProjects/checkPageData',
...
function queryProject() {
	$('#researchProjects_check_tab').datagrid('load', {
...
function CZ(val, row) {
	...
	if ( c == 1 || c == 2) {
		return 	'<table><tr style="width: 75px;height:20px"><td style="width: 25px">'+
				...
				'<a href="#" onclick="check_project(' + row.fpId + ')" class="easyui-linkbutton">'+
...
function check_project(id) {
	var win = creatWin('审批', 1105, 580, 'icon-search', '/researchProjects/check?id='+id);
	win.window('open');
}
//修改
