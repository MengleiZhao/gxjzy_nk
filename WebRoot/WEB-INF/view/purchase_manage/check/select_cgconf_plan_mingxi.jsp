...
<thead>
	<tr>
		...
		<th data-options="field:'fIsArgument',align:'center',width:110,formatter:isornoArgument">是否论证</th>
...
<div id="td_Id" style="height:30px;margin-bottom:5px;margin-top:5px">
	<a style="color: red;">申请总额：</a><input style="width: 100px;" id="totalPrice" name="ffinalPrice" value="${bean.fpAmount }" class="easyui-numberbox"  readonly="readonly" data-options="precision:2,icons: [{iconCls:'icon-yuan'}]"/>
</div>
