...
<form id="supplierForm">
	<table id="supplierTab" class="window-table" style="margin-top: 10px;width: 700px;overflow: hidden;" cellspacing="0" cellpadding="0" >
		<tbody id="supplier_0" style="overflow:hidden;">
			<tr>
				<td class="td1"></td>
				<td class="td1"></td>
				<td>供应商</td>
			...
			<tr>
				...
				<td colspan="4">
					<input class="easyui-textbox" id="F_fwName_0" name="fwName" required="required" data-options="" style="width: 587px;height: 30px;" value=""/>
				</td>
			</tr>	
			...
			<tr>
				...
				<td class="td2">
					<input class="easyui-textbox" id="F_fwuserName_0"  name="fwuserName" data-options="" style="width: 230px; height: 30px;" value=""/>
				</td>
				<td class="td1" style="width: 120px"><span class="style1">*</span>&nbsp;成交日期</td>
				<td class="td2">
					<input class="easyui-datebox" id="F_flastDealTime_0" name="flastDealTime" required="required" data-options="editable:false" style="width: 230px; height: 30px;" value=""/>
				</td>
			...
			<tr>
				...
				<td class="td2">
					<input class="easyui-textbox" id="F_fwTel_0" name="fwTel" data-options="validType:'length[11,11]'" style="width: 230px; height: 30px;" value=""/>
				</td>
				<td class="td1" style="width: 120px">座机号码</td>
				<td class="td2">
					<input class="easyui-textbox" id="F_fwStorageTel_0" name="fwStorageTel" data-options="validType:'length[10,12]'" style="width: 230px; height: 30px;" value=""/>
				</td>
			</tr>
			<tr>
				<td class="td1" style="width: 70px"><span class="style1">*</span>&nbsp;成交金额[元]</td>
				<td class="td2">
					<input class="easyui-numberbox" id="F_dealAmount_0" name="dealAmount" required="required" data-options="precision:2,onChange:dealAmountCheck"  style="width: 230px; height: 30px;" value="0"/>
				</td>
				<td class="td1" style="width: 70px"><span class="style1">*</span>&nbsp;允许浮增金额[元]</td>
				<td class="td2">
					<input class="easyui-numberbox" id="F_floatAmount_0" name="floatAmount" required="required" data-options="precision:2,onChange:floatAmountCheck"  style="width: 230px; height: 30px;" value="0"/>
				</td>
			...
			<tr>
				...
				<td colspan="4" style="margin-top: 10px;">
					<input class="easyui-textbox" id="F_fwRemark_0" name="fwRemark" data-options="validType:'length[1,200]',multiline:true" style="width:587px;height:70px;" value=""/>
				</td>
			</tr>
	...
	$('#supplierTab').append(
		'<tbody id="supplier_'+a+'">'+
			...
			'<tr>'+
				...
				'<td class="td1" style="width: 120px">座机号码</td>'+
				'<td class="td2">'+
					'<input class="easyui-textbox" id="F_fwStorageTel_'+a+'" name="fwStorageTel" data-options="validType:\'length[10,12]\'" style="width: 230px; height: 30px;" value="${fwbean.fwStorageTel}"/>'+
				'</td>'+
			'</tr>'+
			'<tr>'+
				'<td class="td1" style="width: 70px"><span class="style1">*</span>&nbsp;成交金额[元]</td>'+
			...
			'<tr>'+
				'<td class="td1" valign="top">&nbsp;&nbsp;备注</td>'+
				'<td colspan="4" style="margin-top: 10px;">'+
					'<input class="easyui-textbox" id="F_fwRemark_'+a+'" name="fwRemark" data-options="multiline:true" style="width:587px;height:70px;" value="${fwbean.fwRemark}"/>'+
				'</td>'+
			'</tr>'+
		'</tbody>'
	);
