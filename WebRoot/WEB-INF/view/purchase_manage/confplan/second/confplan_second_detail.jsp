...
<body>
<div class="win-div">
<form id="confplan_secondUp_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
						...
						<table cellpadding="0" cellspacing="0" collapsible="false" class="ourtable" border="0">
							<tr class="trbody">
								...
								<td class="td4">
									...
									<input type="hidden" id="cgconfplan_list_sblx" name="sblx" value="${sblx }" />
									<!-- 上报阶段  1：一上   2：二上 -->
									<input type="hidden" id="cgconfplan_list_freportStage" name="freportStage" value="${freportStage }" /> 
							...
							<tr>
								...
								<td  colspan="4">
									<input id="F_subName" class="easyui-textbox" name="subName" readonly="readonly" data-options="icons: [{iconCls:'icon-sousuo'}]" value="${bean.subName}" style="width: 555px"/>
								</td>
							</tr>
							<tr>
