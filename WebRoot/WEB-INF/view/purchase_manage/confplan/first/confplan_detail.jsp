					...
					<div title="配置计划信息" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false," style="overflow:auto;margin-top: 10px;">
						<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
							...
							<tr >
								...
								<td  colspan="4">
									<input id="F_subName" class="easyui-textbox" name="subName" readonly="readonly" required="required" data-options="prompt:'单击选择预算支出明细',validType:'length[1,32]'" value="${bean.subName}" style="width: 555px"/>
								</td>
							</tr>
							<tr>
								<td class="td1"><span class="style1">*</span>&nbsp;预算金额</td>
								<td class="td2">
									<input class="easyui-numberbox" id="F_outAmount"  name="outAmount"  readonly="readonly" required="required" data-options="precision:2,icons: [{iconCls:'icon-yuan'}]" style="width: 200px" value="${bean.outAmount}"/>
								</td>
								<td class="td4"></td>
