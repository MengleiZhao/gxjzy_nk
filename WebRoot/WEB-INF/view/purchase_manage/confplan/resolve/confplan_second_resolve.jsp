...
<body>
<div class="win-div">
<form id="confplan_resolve_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
	<div class="easyui-layout" style="height: 509px;">
		<div class="win-left-div" data-options="region:'west',split:true">
					...
					<div title="下达信息" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top: 10px;">
						<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
							...
							<tr style="height: 70px;">
								...
								<td colspan="4">
									<textarea class="textbox-text" id="F_fapproveIdea" name="fapproveIdea" required="required" oninput="textareaNum(this,'textareaNum3')" autocomplete="off" style="width:555px;height:70px;resize:none">${bean.fapproveIdea }</textarea>
								</td>
							</tr>
							<tr>
								<td align="right" colspan="5" style="padding-right: 00px;">
									可输入剩余数：<span id="textareaNum3" class="200">
										<c:if test="${empty bean.fapproveIdea}">200</c:if>
										<c:if test="${!empty bean.fapproveIdea}">${200-bean.fapproveIdea.length()}</c:if>
									</span>
								</td>
							</tr>
						</table>
			...
			<div class="win-left-bottom-div">
				<a href="javascript:void(0)" onclick="saveConfplan()">
...
//保存
function saveConfplan() {
	//提交
	$('#confplan_resolve_form').form('submit', {
		onSubmit : function() {
		...
		url : base + '/cgconfplan/resolveSave',
