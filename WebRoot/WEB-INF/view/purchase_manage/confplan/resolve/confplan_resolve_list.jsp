...
<div class="list-div">
	...
	<div class="list-table-tab2">
		<div class="tab-wrapper" id="resolve-tab">
			<ul class="tab-menu">
				<li class="active" onclick="notResolve();">未一下</li>
			    <li onclick="resolve();">已一下</li>
			</ul>
			
			<div class="tab-content">
				<div style="height: 410px;">	
					<table id="confplan_resolve_tab1" class="easyui-datagrid"
						data-options="collapsible:true,url:'${base}/cgconfplan/confplanResolvePageData?status=0&fcheckStauts=9&freportStage=${freportStage }',
...
<script type="text/javascript">
	...
	//type为一下状态	0-未一下	1-已一下
	var type = 0;
	function notResolve() {	//未一下
		type = 0;
	...
	function confplan_resolve(id) {
		var win = parent.creatWin('下达', 970, 580, 'icon-search', '/cgconfplan/resolve?id='+id);
		win.window('open'); 
  	}
	
	//查看
	function confplan_detail(id) {
		var win = parent.creatWin('查看', 970, 580, 'icon-search', '/cgconfplan/resolveDetail?id='+id);
		win.window('open'); 
	} 
</script>
</body>