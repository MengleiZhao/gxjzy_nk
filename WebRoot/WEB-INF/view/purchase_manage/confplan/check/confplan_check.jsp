						...
						<table cellpadding="0" cellspacing="0" class="ourtable" border="0">
							<tr class="trbody">
								...
								<td class="td4">
									...
									<!-- 预算支出明细主见ID -->	<input type="hidden" name="pid" id="F_pid" value="${bean.pid}" />
									<!-- 预算支出明细编码  -->	<input type="hidden" name="expCode" id="F_expCode" value="${bean.expCode}" />
									<!-- 科目编码  -->			<input type="hidden" name="subCode" id="F_subCode" value="${bean.subCode}" />
