...
<form id="bid_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
	...
	<div class="easyui-accordion" style="width:717px;margin-left: 20px;margin-right: 20px;">
	...
	<!-- 采购金额  --><input type="hidden" id="F_fpAmount" value="${bean.fpAmount}"/>
	<input type="hidden" name="fpId" id="F_fpId" value="${bean.fpId}"/><!--采购的主键id  -->
	<input type="hidden" name="fbId" id="F_fbId" value="${br.fbId}"/><!--采购登记的主键id  -->
	<input type="hidden" name="form" id="json1">
	<input type="hidden" name="files" id="files">
	
	<!-- 预算信息 -->
		<!-- 第一个div -->
		<div title="采购信息" data-options=" collapsible:false" style="overflow:auto;width:707px;">
			<table class="window-table" cellspacing="0" cellpadding="0" style="margin-top: 3px;width:707px;">
				<tr class="trbody" hidden="hidden">
					...
					<td class="td2">
						<input class="easyui-textbox" id="F_fpCode" readonly="readonly" style="width:220px;height: 30px" value="${bean.fpCode}"/>
					</td>
					<td class="td1"><span class="style1">*</span>&nbsp;申请时间</td>
					<td class="td2">
						<input class="easyui-datebox" class="dfinput" id="F_fReqTime" readonly="readonly" style="width: 220px;height: 30px" value="${bean.fReqTime}"/>
					</td>			
				...
				<tr class="trbody">
					...
					<td class="td2">
						<input class="easyui-textbox" type="text" id="F_fDeptName" readonly="readonly" style="width: 220px;height: 30px" value="${bean.fDeptName}"/>
					</td>
					
					<td class="td1"><span class="style1">*</span>&nbsp;申请人</td>
					<td class="td2">
						<input id="F_fUserName" class="easyui-textbox" type="text" readonly="readonly" style="width: 220px;height: 30px" value="${bean.fUserName}"/>
					</td>
...
<!-- 采购清单 -->
<%-- <div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;width:717px;">
  	<div title="采购清单" data-options="collapsible:false" style="overflow:auto;">
...
<!-- 审批记录 -->
<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;width:717px;">
	<div title="审批记录" data-options="collapsible:false" style="overflow:auto;width:707px;">
		<jsp:include page="../../check_history_cg.jsp" />
	</div>
</div>
