...
<table class="window-table" cellspacing="0" cellpadding="0">
	...
	<tr class="trbody">
		...
		<td class="td2">
			<input class="easyui-textbox" required="required" id="payeeName" readonly="readonly" style="width: 200px;  height: 30px;" value="${payee.payeeName}" />
		</td>
	...
	<tr class="trbody">
		...
		<td class="td2">
			<input class="easyui-numberbox" id="payeeAmount" required="required" readonly="readonly" style="width: 200px;  height: 30px;" value="${bean.amount}" data-options="precision:2,icons: [{iconCls:'icon-yuan'}]"/>
		</td>
		
		<td class="td1"><span class="style1">*</span>&nbsp;付款方式</td>
		<td class="td2">
			<input class="easyui-combobox" id="paymentTypeShow" required="required" readonly="readonly" value="${bean.paymentType}"  style="width: 200px; height: 30px;" data-options="validType:'selectValid',editable:false,url:base+'/lookup/lookupsJson?parentCode=FKFS&selected=${bean.paymentType}',method:'POST',valueField:'text',textField:'text'"/>
		</td>
	</tr>
	<tr class="trbody" id="bank-info1">
		<td class="td1"><span class="style1">*</span>&nbsp;银行卡号</td>
		<td colspan="4">
			<input class="easyui-textbox" required="required" style="width: 532px; height: 30px;" readonly="readonly" id="bankAccount" name="bankAccount" value="${payee.bankAccount}" />
		</td>
	</tr>
	<tr class="trbody" >
		<td class="td1"><span class="style1">*</span>&nbsp;开户行</td>
		<td colspan="4">
			<input class="easyui-textbox" required="required" id="bankName" style="width: 532px; height: 30px;" readonly="readonly" name="bank" value="${payee.bank}" />
		</td>
	</tr>
