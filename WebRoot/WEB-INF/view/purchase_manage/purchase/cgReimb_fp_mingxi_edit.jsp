...
<form id="form1">
					...
					<td class="td2" colspan="3" id="">
						<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
							<p style="margin-bottom:10px;">
								...
								<input class="input_amonut1 a easyui-numberbox" name="amount" id="contractAmount_${i.index}" value="${invoice.amount }" onchange="commaddAmonut(this)"data-options="precision:2"/>
							</p>
	...
	<a onclick="commappendCG(this)" style="font-weight: bold;vertical-align: middle;margin-left: 308px;" href="#">
...
function commappendCG(obj) {
	...
	'<input class="input_amonut1 a easyui-numberbox" name="amount" id="contractAmount_'+a+'" onchange="commaddAmonut(this)"data-options="precision:2"/>'+
	'</p>'+
	'<p style="margin-bottom:5px;" >'+
