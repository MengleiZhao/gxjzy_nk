...
<body>
<form id="cgsq_check_form" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
			...
			<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;">
						...
						style="overflow:auto;">
							<div style="overflow:hidden;margin-top: 0px">
								<jsp:include page="cgReimb_fp_mingxi_detail.jsp" />
							</div>
						</div>
			</div>
			<div class="easyui-accordion" style="margin-left: 20px;margin-right: 20px;">
