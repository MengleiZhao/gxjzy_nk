...
<div style="margin-top: 5px;margin-bottom: 5px;height: 15px;">
	<a style="float: left; font-weight: bold;color: #005E8A;font-size:12px;"></a>
	<a style="float: left;">&nbsp;&nbsp;</a>
</div>
<form id="form1">
	<table id="purchasefapiao" class="window-table-readonly-zc" cellspacing="0" cellpadding="0" style=" height: 100px;width:695px;">
		<tbody id="comm_0" >
			<tr>
				<td class="td1" style="width: 100px;">
					&nbsp;&nbsp;<span id="contractFp_0">发票1</span>
					<input type="text" id="contractfp_0" name="fileId" hidden="hidden">
					<input type="file" id="contractImage_0"accept="image/jpeg,image/jpg,image/png" onchange="contractUpImageFile(this)" hidden="hidden">
				</td>
				<td class="td2" colspan="3" id="contractimagetd_0" style="width: 150px;">
					<a onclick="contractClickUpFile(this)" id="contractClick_0" style="font-weight: bold;" href="#">
				...
				<td class="td2" colspan="3" id="">
					<div style="width: auto; height:auto; height:auto;margin-top:5px;margin-left:49px;width: 300px;">
						<p style="margin-bottom:10px;">
							...
							<input class="input_amonut1 a easyui-numberbox" name="amount" id="contractAmount_0" onchange="contractaddAmonut(this)"data-options="precision:2"/>
						</p>
						<p style="margin-bottom:5px;" >
							<span class="contractfp_span">备注：</span>
							<input  class="input_amonut1 easyui-textbox" name="remark" id="contractRemark_0" value="" />
						</p>
					</div>
				</td>
			</tr>
...
function contractappend(obj) {
	...
	$('#purchasefapiao').append('<tbody id="comm_'+a+'" >'+
					...
					success : function(data) {
			        	...
			        	if(y!=0){
							...
							.append(
				        		...
				        		$('#contractimagetd_'+j).append('<img style="vertical-align:bottom;margin-left:0px; width: 100px;height: 73px" src="'+data+'" onclick="yl(this.src)"/><a style="color:red" href="#" id="sc_'+j+'" onclick="commdeleteImage(this)">    删除</a>');
				        	}
...
function  contractdelete(item){
	...
	for(var i=1;i<fromNum;i++){
		if('comm'==arr[0]){
			var tableId = $('#purchasefapiao').find('tbody');
