...
<div class="window-tab" style="margin-left: 0px;margin-top: 10px">
	<table id="check-history-dg-cg" class="easyui-datagrid"  style="width:700px;height:auto"
	data-options="
	<c:if test="${empty foCodeCG}">
	url: '',
	</c:if>
	<c:if test="${!empty foCodeCG}">
	url: '${base}/wflow/history?fpId=${fpIdCG}&foCode=${foCodeCG}',
	</c:if>
	method: 'post'
	">
	<thead>
