...
<div class="window-tab" style="margin-left: 0px;margin-top: 10px">
	<table id="check-history-dg-gd" class="easyui-datagrid"  style="width:700px;height:auto"
	data-options="
	<c:if test="${empty foCodeGD}">
	url: '',
	</c:if>
	<c:if test="${!empty foCodeGD}">
	url: '${base}/wflow/history?fpId=${fpIdGD}&foCode=${foCodeGD}',
	</c:if>
	method: 'post'
	">
	<thead>
