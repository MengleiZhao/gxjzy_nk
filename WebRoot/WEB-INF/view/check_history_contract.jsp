...
<div class="window-tab" style="margin-left: 0px;margin-top: 10px">
	<table id="check-history-dg-contract" class="easyui-datagrid"  style="width:700px;height:auto"
	data-options="
	<c:if test="${empty foCodeCON}">
	url: '',
	</c:if>
	<c:if test="${!empty foCodeCON}">
	url: '${base}/wflow/history?fpId=${fpIdCON}&foCode=${foCodeCON}',
	</c:if>
	method: 'post'
	">
	<thead>
