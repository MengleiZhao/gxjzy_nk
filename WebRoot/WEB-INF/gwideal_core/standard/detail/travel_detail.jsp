...
<div class="win-div">
<form id="hotelstd_add_form" action="${base}/hotelStandard/save" method="post" data-options="novalidate:true" class="easyui-form" enctype="multipart/form-data">
							...
							<div title="住宿费" data-options="iconCls:'icon-xxlb',collapsed:true,collapsible:true" style="overflow:auto;margin-top:10px;">
								<table class="ourtable" cellpadding="0" cellspacing="0">
									...
									<tr class="trbody">
										<td class="td1">地区</td>
										<td colspan="3">
											<input id="hotelstd_add_area" readonly="readonly" name="area" value="${bean.area }"
												class="easyui-textbox" data-options="required:true"/>
										</td>
									</tr>
									
									<tr class="trbody">
										<td class="td1">住宿费标准（市级）</td>
										<td class="td2">
											<input id="hotelstd_add_normalPriceMax" readonly="readonly" name="normalPriceMax" value="${bean.normalPriceMax }"
												class="easyui-numberbox"/>
										</td>
										<td class="td1">住宿费标准（局级）</td>
										<td class="td2" style="width:150px;">
											<input id="hotelstd_add_normalPriceMid" readonly="readonly" name="normalPriceMid" value="${bean.normalPriceMid }"
												class="easyui-numberbox"/>
										</td>
									</tr>
									...
									<tr class="trbody">
										...
										<td colspan="3">
											<input id="hotelstd_add_normalPriceMin" readonly="readonly" name="normalPriceMin" value="${bean.normalPriceMin }"
												class="easyui-numberbox" />
										</td>
									</tr>
								...
								<table class="ourtable" cellpadding="0" cellspacing="0">
										...
										<tr class="trbody">
											...
											<td colspan="3">
												...
												<input id="hotelstd_add_sfwj" readonly="readonly" name="hasBusy" value="1"
													type="radio" onclick="selectSfwj(this)" <c:if test="${bean.hasBusy==1 }">checked="checked"</c:if>/>是
												<input id="hotelstd_add_sfwj" readonly="readonly" name="hasBusy" value="0"
										...
										<tr class="trbody sfwj" id="test">
											...
											<td class="td2" colspan="3">
												<input id="hotelstd_add_busyRate" readonly="readonly" name="busyRate" value="${bean.busyRate }"
										...
										<tr class="trbody sfwj">
											...
											<td class="td2">
												<input id="hotelstd_add_busyDateStart" readonly="readonly" name="busyDateStart" value="${bean.busyDateStart }"
													class="easyui-datebox" style="width:170px;" />
											</td>
											<td class="td1">旺季结束时间</td>
											<td class="td2" style="width:150px;">
												<input id="hotelstd_add_busyDateEnd" readonly="readonly" name="busyDateEnd" value="${bean.busyDateEnd }"
													class="easyui-datebox" style="width:170px;"/>
											</td>
										</tr>
								
										<tr class="trbody sfwj">
											<td class="td1">旺季上浮价（市级）</td>
											<td class="td2">
												<input id="hotelstd_add_busyPriceMax" readonly="readonly" name="busyPriceMax" value="${bean.busyPriceMax }"
													class="easyui-numberbox" style="width:170px;"/>
											</td>
											<td class="td1">旺季上浮价（局级）</td>
											<td class="td2" style="width:150px;">
												<input id="hotelstd_add_busyPriceMid" readonly="readonly" name="busyPriceMid" value="${bean.busyPriceMid }"
													class="easyui-numberbox" style="width:170px;"/>
											</td>
										</tr>
										...
										<tr class="trbody sfwj">
											...
											<td colspan="3">
												<input id="hotelstd_add_busyPriceMin" readonly="readonly" name="busyPriceMin" value="${bean.busyPriceMin }"
													class="easyui-numberbox" style="width:170px;"/>
											</td>
										</tr>
						...
						<div title="长途交通费" data-options="iconCls:'icon-xxlb',collapsed:true,collapsible:true" style="overflow:auto;margin-top:10px;">
							<table class="ourtable" cellpadding="0" cellspacing="0">
								<tr class="trbody">
									<td class="td1">费用标准</td>
									<td colspan="3">
										<input id="hotelstd_add_costTrafficLong" readonly="readonly" name="costTrafficLong" value="${bean.costTrafficLong }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
							</table>
						...
						<div title="市内交通费" data-options="iconCls:'icon-xxlb',collapsed:true,collapsible:true" style="overflow:auto;margin-top:10px;">
							<table class="ourtable" cellpadding="0" cellspacing="0">
								<tr class="trbody">
									<td class="td1">费用标准</td>
									<td colspan="3">
										<input id="hotelstd_add_costTrafficShort" readonly="readonly" name="costTrafficShort" value="${bean.costTrafficShort }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
							</table>
						...
						<div title="杂费" data-options="iconCls:'icon-xxlb',collapsed:true,collapsible:true" style="overflow:auto;margin-top:10px;">
							<table class="ourtable" cellpadding="0" cellspacing="0">
								<tr class="trbody">
									<td class="td1">费用标准</td>
									<td colspan="3">
										<input id="hotelstd_add_costExtras" readonly="readonly" name="costExtras" value="${bean.costExtras }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
							</table>
