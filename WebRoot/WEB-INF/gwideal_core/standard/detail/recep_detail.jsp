						...
						<div title="伙食费(外宾)" data-options="iconCls:'icon-xxlb',collapsed:false,collapsible:false" style="overflow:auto;margin-top:10px;">
							<table class="ourtable" cellpadding="0" cellspacing="0">
								<tr class="trbody">
									...
									<td colspan="3">
										<input id="hotelstd_add_costFood4" readonly="readonly" name="costFood4" value="${bean.costFood4 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
								<tr class="trbody">
									...
									<td colspan="3">
										<input id="hotelstd_add_costFood5"  readonly="readonly" name="costFood5" value="${bean.costFood5 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
								<tr class="trbody">
									<td class="td1">冷餐</td>
									<td colspan="3">
										<input id="hotelstd_add_costFood6" readonly="readonly" name="costFood6" value="${bean.costFood6 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
								<tr class="trbody">
									<td class="td1">酒会</td>
									<td colspan="3">
										<input id="hotelstd_add_costFood7" readonly="readonly" name="costFood7" value="${bean.costFood7 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
								<tr class="trbody">
									<td class="td1">茶会</td>
									<td colspan="3">
										<input id="hotelstd_add_costFood8" readonly="readonly" name="costFood8" value="${bean.costFood8 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
								<tr class="trbody">
									...
									<td colspan="3">
										<input id="hotelstd_add_costFood9" readonly="readonly" name="costFood9" value="${bean.costFood9 }"
											class="easyui-numberbox" data-options=""/>
									</td>
								</tr>
							</table>
