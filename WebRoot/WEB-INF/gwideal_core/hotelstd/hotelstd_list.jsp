			...
			selectOnCheck: true,checkOnSelect:true,remoteSort:true,nowrap:false,striped: true,fitColumns: true" >
				<thead>
					<tr>
						...
						<th data-options="field:'normalPriceMax',align:'right'" width="10%">住宿费标准（市级）</th>
						<th data-options="field:'normalPriceMid',align:'right',resizable:false,sortable:true" width="10%">住宿费标准（局级）</th>
