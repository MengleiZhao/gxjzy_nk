...
var t=$(_d1);
return $.extend({},$.parser.parseOptions(_d1,[{total:"number",pageSize:"number",pageNumber:"number",links:"number"},{loading:"boolean",showPageList:"boolean",showPageInfo:"boolean",showRefresh:"boolean"}]),{pageList:(t.attr("pageList")?eval(t.attr("pageList")):true)});
};
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:true,showPageInfo:true,showRefresh:true,links:10,layout:['sep','first','prev','links','next','last'],onSelectPage:function(_d2,_d3){
},onBeforeRefresh:function(_d4,_d5){																																				//["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh","info"]原始		//['sep','first','prev','links','next','last']			//['sep','first','prev','links','next','last']没有数字只有翻页按钮																														
...
$(_239).panel("clear");
/*$(_239).html($("<div class=\"panel-loading\"></div>").html(opts.loadingMessage));                 easyui自带的老的loading样式*/
$(_239).html($("<div class=\"loading\">\n<span></span>\n<span></span>\n<span></span>\n<span></span>\n<span></span>\n</div>"));   //新的loading叶添加（换行符\n必须要添加不然挤在一起）
}
...
p_t.css("height",24+"px");		//叶添加 tab头部的按钮高度
p_t.css("margin-top",2+"px");	//叶添加 tab头部的按钮离上高度
...
var tab=$("<li>"+"<a href=\"javascript:;\" class=\"tabs-inner\">"+"<span class=\"tabs-title\"></span>"+"<span class=\"tabs-icon\"></span>"+"</a>"+"</li>");//onclick=\"dynamicLoading.css('/nkgl/resource/ui/themes/default/easyui.css');\"
if(!pp){
pp=$("<div></div>");
}
...
if(opts.multiline){
$("<textarea id=\""+_505+"\" class=\"textbox-text\" oninput=\"textareaNum(this)\" autocomplete=\"off\"></textarea>").prependTo(tb);
}else{
...
//非法字符校验	
	reg=/[`~!#$^]/im;
	if(reg.test(_53e)){
		alert("提示：您输入的信息含有非法字符！请重新输入.");
		$(this).textbox("setValue",_53f);
	}
opts.onChange.call(this,_53e,_53f);//回call
...
var dc=_699.dc;
var wrap=_699.panel;
var _69a=wrap.width();		//叶修改 easyui表格左右有为滚动条预留20px的位子，我去掉了
...
//最后一列列不对齐问题
if(!_6d2){
	if(col.field == lastField){
		cell.css("margin-right","14px");
	}
}
...
e.preventDefault();
e.stopPropagation();
}},panelWidth:null,panelHeight:"auto",panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:350,panelAlign:"left",reversed:false,multiple:false,multivalue:true,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
