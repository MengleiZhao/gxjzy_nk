...
public class JpushClientUtil {
    ...
    private final static String appKey = "4080302773eea7f0c0cd4dc5";

    private final static String masterSecret = "e7198b0faaff55b0b6592b1e";

    private static JPushClient jPushClient = new JPushClient(masterSecret,appKey);

    /**
     * 推送给设备标识参数的用户
     * @param registrationId 设备标识(别名)
     * @param notification_title 通知内容标题
     * @param msg_title 消息内容标题
     * @param msg_content 消息内容
     * @param extrasparam1 扩展字段1
     * @param extrasparam2 扩展字段2
     * @param extrasparam3 扩展字段3
     * @return 0推送失败，1推送成功
     */
    public static int sendToRegistrationId( String registrationId,String notification_title, String msg_title, String msg_content, String extrasparam1,String extrasparam2, String extrasparam3) {
        int result = 0;
        try {
            PushPayload pushPayload= JpushClientUtil.buildPushObject_all_registrationId_alertWithTitle(registrationId,notification_title,msg_title,msg_content,extrasparam1,extrasparam2,extrasparam3);
    ...
    private static PushPayload buildPushObject_all_registrationId_alertWithTitle(String alias1, String notification_title, String msg_title, String msg_content, String extrasparam1, String extrasparam2, String extrasparam3) {
...
//                                .setTitle(notification_title)
                                ...
                                .addExtra("checkType",extrasparam2)
                                .addExtra("taskType",extrasparam3)
...
//                                .build())
    ...
    private static PushPayload buildPushObject_android_all_alertWithTitle(String notification_title, String msg_title, String msg_content, String extrasparam, String type, String value) {
        ...
        return PushPayload.newBuilder()
                ...
                //指定推送的接收对象，all代表所有人，也可以指定已经设置成功的tag或alias或该应应用客户端调用接口获取到的registration id
                //根据别名推送
                .setAudience(Audience.registrationId(value))
...
/*        if(JpushClientUtil.sendToAllAndroid("推送给所有Android用户","公众号","霸道的程序猿","101")==1)
        {
            System.out.println("推送给所有Android用户success");
        }*/
        if(JpushClientUtil.sendToRegistrationId("pengqiang","推送给指定Android用户","管理员1","你的事项已审批通过","102", "22","extrasparam2")==1){
