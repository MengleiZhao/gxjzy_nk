 ...
 */
@Entity
@Table(name = "t_pro_basic_info")
@JsonIgnoreProperties(ignoreUnknown = true)
public class TProBasicInfo extends BaseEntityEmpty implements java.io.Serializable,EntityDao,CheckEntity{

	private Integer FProId;
	private String FProName;//项目名称
	private String FProCode;//项目编号
	private Lookups FProType;//项目类型   0-基本 1-项目 2-子项目
	private String FProLibType;//所属库 1：备选库 2：上报库   3：执行中 4：已完结 5：子项目申报
	private BigDecimal FProBudgetAmount;//项目预算金额
	private String FProcurementYn;//是否采购项目
	private BigDecimal FProcurementAmount;//采购金额
	private String FProHead;//项目负责人
	private String FProHeadId;//项目负责人id
	...
	上报库 二上   30:暂存                     31：提交，待审核                -31：已退回（所有流程如驳回，则直接回退至申请人）             39：已审核                   */
	...
	private Integer FProOrBasic;//预算支出类型     区分基本支出或项目支出：0=基本支出，1=项目支出 2=大项目
	private Integer fprocurementStatus;//是否政府采购     0=否，1=是              2021-5-12  赵孟雷  添加
	...
	//一上申报数
	private BigDecimal commitAmount1;
	//一下控制数
	private BigDecimal provideAmount1;
	//一下控制财拨结余数
	private BigDecimal leastAmount1;
	//二下批复财拨结余数
	private BigDecimal provideLeastAmount2;
	//二上申报数
	private BigDecimal commitAmount2;
	//二上报财结余数
	private BigDecimal commitLeastAmount2;
	//下环节处理人 姓名
	...
	//大项目名称
	private String bigProName;
	//大项目id
	private Integer bigProId;
	//子项目导入状态 0-未导入 1-已导入
	private String zxmImportStatus;
	//子项目id
	private Integer zxmId;
	...
	private BigDecimal controlNum;//预算控制数
	...
	private BigDecimal efficiency1;		//执行进度区间（执行进度区间查询开始）
	private BigDecimal efficiency2;		//执行进度区间（执行进度区间查询结束）
	
	private String planStartYear1;		//项目开始执行年份区间（项目开始执行年份区间查询开始）
	private String planStartYear2;		//项目开始执行年份区间（项目开始执行年份区间查询结束）
	
	//保存项目支出明细
	private List<TProExpendDetail> expendList;
	//保存项目支出计划
	...
	private BigDecimal efficiency;//项目执行率(数据库中没有，用于前台)
	private BigDecimal syAmount;//剩余金额(数据库中没有，用于前台)
	private BigDecimal djAmount;//剩余金额(数据库中没有，用于前台)

	private String ifPurchaseManyYearsPro;//是否为一采多年项目
	
	private String ifPurchaseManyYearsSEPro;//是否为一采多年项目信息网络及软件购置更新
	
	private String ifScientificPro;//是否为科研项目
	
	private String scientificProId;//科研项目信息id
	
	private String scientificProName;//科研项目信息名称
	
	private String ifInvolveNetworkSoftware;//政府采购是否涉及信息网络及软件购置更新
	
	private BigDecimal governmentPurAmount;//政府采购金额
	
	private BigDecimal governmentSEPurAmount;//政府软件采购金额
	
	private String reason;//结转理由
	private String fjzspzt;//结转审批状态
	private String fjzclrbm;//结转处理人编码
	
	
	private String year;  //年度
	
	private String implementProgress;	 //项目实施进展情况
	
	private String yearTarget;	 //年度绩效目标
	
	private String mediumTarget;	 //中期绩效目标
	private String proUseType;	 //预算使用类型 JJ基建 WX维修 SBGZ设备购置
	
	
	private String proApplyType;//项目申请类型
	// Property accessors
	...
	@Column(name ="F_FJZCLRBM")
	public String getFjzclrbm() {
		return fjzclrbm;
	}

	public void setFjzclrbm(String fjzclrbm) {
		this.fjzclrbm = fjzclrbm;
	}

	@Column(name ="F_FJZSPZT")
	public String getFjzspzt() {
		return fjzspzt;
	}

	public void setFjzspzt(String fjzspzt) {
		this.fjzspzt = fjzspzt;
	}
	...
	public BigDecimal getFProBudgetAmount() {
		return this.FProBudgetAmount;
	}

	public void setFProBudgetAmount(BigDecimal FProBudgetAmount) {
	...
	public BigDecimal getFProcurementAmount() {
		return this.FProcurementAmount;
	}

	public void setFProcurementAmount(BigDecimal FProcurementAmount) {
	...
	@Column(name = "F_PRO_HEAD_ID", length = 50)
	public String getFProHeadId() {
		return FProHeadId;
	}

	public void setFProHeadId(String fProHeadId) {
		FProHeadId = fProHeadId;
	}
	...
	@Column(name = "F_CB_1")
	public BigDecimal getCommitAmount1() {
		return commitAmount1;
	}

	public void setCommitAmount1(BigDecimal commitAmount1) {
		this.commitAmount1 = commitAmount1;
	}

	@Column(name = "F_KZCB_1")
	public BigDecimal getProvideAmount1() {
		return provideAmount1;
	}

	public void setProvideAmount1(BigDecimal provideAmount1) {
		this.provideAmount1 = provideAmount1;
	}

	@Column(name = "F_KZCB_JY_1")
	public BigDecimal getLeastAmount1() {
		return leastAmount1;
	}

	public void setLeastAmount1(BigDecimal leastAmount1) {
		this.leastAmount1 = leastAmount1;
	}

	@Column(name = "F_RP_CB_JY_2")
	public BigDecimal getProvideLeastAmount2() {
		return provideLeastAmount2;
	}

	public void setProvideLeastAmount2(BigDecimal provideLeastAmount2) {
		this.provideLeastAmount2 = provideLeastAmount2;
	}

	@Column(name = "F_CB_2")
	public BigDecimal getCommitAmount2() {
		return commitAmount2;
	}

	public void setCommitAmount2(BigDecimal commitAmount2) {
		this.commitAmount2 = commitAmount2;
	}

	@Column(name = "F_CB_JY_2")
	public BigDecimal getCommitLeastAmount2() {
		return commitLeastAmount2;
	}

	public void setCommitLeastAmount2(BigDecimal commitLeastAmount2) {
	...
	@Transient
	public List<TProExpendDetail> getExpendList() {
		return expendList;
	}

	public void setExpendList(List<TProExpendDetail> expendList) {
	...
	@Transient
	public BigDecimal getEfficiency1() {
		return efficiency1;
	}

	public void setEfficiency1(BigDecimal efficiency1) {
		this.efficiency1 = efficiency1;
	}

	@Transient
	public BigDecimal getEfficiency2() {
		return efficiency2;
	}

	public void setEfficiency2(BigDecimal efficiency2) {
	...
	@Column(name ="F_PROCUREMENT_STATUS")
	public Integer getFprocurementStatus() {
		return fprocurementStatus;
	}

	public void setFprocurementStatus(Integer fprocurementStatus) {
		this.fprocurementStatus = fprocurementStatus;
	}
	...
	@Column(name ="F_BIG_PRO_ID")
	public Integer getBigProId() {
		return bigProId;
	}
	
	
	public void setBigProId(Integer bigProId) {
		this.bigProId = bigProId;
	}

	@Column(name ="F_ZXM_IMPORT_STATUS")
	public String getZxmImportStatus() {
		return zxmImportStatus;
	}

	public void setZxmImportStatus(String zxmImportStatus) {
		this.zxmImportStatus = zxmImportStatus;
	}

	@Column(name ="F_ZXM_ID")
	public Integer getZxmId() {
		return zxmId;
	}

	public void setZxmId(Integer zxmId) {
		this.zxmId = zxmId;
	}
	
	@Column(name ="F_IF_SCIENTIFIC_PRO")
	public String getIfScientificPro() {
		return ifScientificPro;
	}

	public void setIfScientificPro(String ifScientificPro) {
		this.ifScientificPro = ifScientificPro;
	}
	@Column(name ="F_SCIENTIFIC_PRO_ID")
	public String getScientificProId() {
		return scientificProId;
	}

	public void setScientificProId(String scientificProId) {
		this.scientificProId = scientificProId;
	}
	
	@Column(name ="F_SCIENTIFIC_PRO_NAME")
	public String getScientificProName() {
		return scientificProName;
	}

	public void setScientificProName(String scientificProName) {
		this.scientificProName = scientificProName;
	}
	
	@Column(name ="F_IF_PURCHASE_MANY_YEARS_PRO")
	public String getIfPurchaseManyYearsPro() {
		return ifPurchaseManyYearsPro;
	}

	public void setIfPurchaseManyYearsPro(String ifPurchaseManyYearsPro) {
		this.ifPurchaseManyYearsPro = ifPurchaseManyYearsPro;
	}
	
	@Column(name ="F_IF_INVOLVE_NETWORK_SOFTWARE")
	public String getIfInvolveNetworkSoftware() {
		return ifInvolveNetworkSoftware;
	}

	public void setIfInvolveNetworkSoftware(String ifInvolveNetworkSoftware) {
		this.ifInvolveNetworkSoftware = ifInvolveNetworkSoftware;
	}
	
	@Column(name ="F_IF_PURCHASE_MANY_YEARS_SE_PRO")
	public String getIfPurchaseManyYearsSEPro() {
		return ifPurchaseManyYearsSEPro;
	}

	public void setIfPurchaseManyYearsSEPro(String ifPurchaseManyYearsSEPro) {
		this.ifPurchaseManyYearsSEPro = ifPurchaseManyYearsSEPro;
	}

	@Column(name="F_GOVERNMENT_PUR_AMOUNT")
	public BigDecimal getGovernmentPurAmount() {
		return governmentPurAmount;
	}

	public void setGovernmentPurAmount(BigDecimal governmentPurAmount) {
		this.governmentPurAmount = governmentPurAmount;
	}

	@Column(name="F_GOVERNMENT_SE_PUR_AMOUNT")
	public BigDecimal getGovernmentSEPurAmount() {
		return governmentSEPurAmount;
	}

	public void setGovernmentSEPurAmount(BigDecimal governmentSEPurAmount) {
		this.governmentSEPurAmount = governmentSEPurAmount;
	}
	...
	@Column(name = "T_IMPLEMENT_PROGRESS")
	public String getImplementProgress() {
		return implementProgress;
	}

	public void setImplementProgress(String implementProgress) {
		this.implementProgress = implementProgress;
	}

	@Column(name = "T_YEAR_TARGET")
	...
	@Column(name = "T_MEDIUM_TARGET")
	public String getMediumTarget() {
		return mediumTarget;
	}

	public void setMediumTarget(String mediumTarget) {
	...
	@Column(name="T_PRO_APPLY_TYPE")
	public String getProApplyType() {
		return proApplyType;
	}

	public void setProApplyType(String proApplyType) {
		this.proApplyType = proApplyType;
	}
}